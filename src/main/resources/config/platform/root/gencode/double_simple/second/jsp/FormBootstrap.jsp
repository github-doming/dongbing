...
<form id="id_form_save"
	action="${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/save/bootstrap.do"
	method="post">
...
<table class="table  table-bordered table-hover" border="1">
	...
	<tr>
		...
		<td><input id="id_input_parent_menu_name"
			...
			onclick="parent('${ay_s}{requestScope.p.path}');" class="btn" type="button"
			value="选择"></td>
		<td width="30%"></td>
	</tr>
...
function parent(path){
	...
	//alert('path='+path);
	var url = "${ay_s}{pageContext.request.contextPath}/${first_pages_name_all}/${first_table_name_module}/${first_table_name_child}/parent/bootstrap.do";
	url=url +"?path="+path;
	var name='newwindow';
 ...
 */
function back(){
var url = "${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/list/bootstrap.do";
