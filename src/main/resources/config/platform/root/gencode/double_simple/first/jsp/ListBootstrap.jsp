...
ayTreeTable_file_click_my= function(db_id,id_tr,id_name,url) {
	...
	var action="${pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/list/bootstrap.do";
 ...
 */
 function editRecord(id){
	 	var url= "${ay_s}{pageContext.request.contextPath}/${first_pages_name_all}/${first_table_name_module}/${first_table_name_child}/form/bootstrap.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${ay_s}{pageContext.request.contextPath}/${first_pages_name_all}/${first_table_name_module}/${first_table_name_child}/form/bootstrap.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${ay_s}{pageContext.request.contextPath}/${first_pages_name_all}/${first_table_name_module}/${first_table_name_child}/del/bootstrap.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
...
<script type="text/javascript">
	 ...
	 */
	function tree(state) {
		var url = "${ay_s}{pageContext.request.contextPath}/${first_pages_name_all}/${first_table_name_module}/${first_table_name_child}/list/bootstrap.do";
