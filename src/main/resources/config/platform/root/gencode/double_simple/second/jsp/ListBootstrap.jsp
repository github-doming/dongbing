...
<form action="${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/list/bootstrap.do"  id="id_form_list" method="post">
...
function delAllRecord(id){
	var url = "${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/del_all/bootstrap.do";
...
function delRecord(id){
	if(confirm("确定要删除吗？"))
	{
		var url = "${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/del/bootstrap.do?id="+id;
...
function updateRecord(id){
	var url= "${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/form/bootstrap.do?id="+id;
	var first${ay_s}tree${ay_s}id=document.getElementById("id_first${ay_s}tree${ay_s}id").value;
	url=url+"&&first${ay_s}tree${ay_s}id="+first${ay_s}tree${ay_s}id;
 	window.location.href=url;
}
 ...
 */
function newRecord(){
 	var url= "${ay_s}{pageContext.request.contextPath}/${second_pages_name_all}/${second_table_name_module}/${second_table_name_child}/form/bootstrap.do";
 	var first${ay_s}tree${ay_s}id=document.getElementById("id_first${ay_s}tree${ay_s}id").value;
 	url=url+"?first${ay_s}tree${ay_s}id="+first${ay_s}tree${ay_s}id;
 	window.location.href=url;
}
