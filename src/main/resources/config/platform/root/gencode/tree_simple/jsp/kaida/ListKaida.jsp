 ...
 */
 function editRecord(id){
	 	var url= "${ay_s}{pageContext.request.contextPath}/${resources_name_all}/${ay_table_name_child}/${ay_table_name_module}/form/kaida.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${ay_s}{pageContext.request.contextPath}/${resources_name_all}/${ay_table_name_child}/${ay_table_name_module}/form/kaida.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${ay_s}{pageContext.request.contextPath}/${resources_name_all}/${ay_table_name_child}/${ay_table_name_module}/del/kaida.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
