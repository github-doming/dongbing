...
<form action="${ay_s}{pageContext.request.contextPath}/${cxy}/${cy_package_name}/${cxy}_${cy_package_name}_${dy_package_name}/admin/${ay_table_name_module}/${ay_table_name_child}/list.do"  id="id_form_list" method="post">
...
function delAllRecord(id){
	var url = "${ay_s}{pageContext.request.contextPath}/${cxy}/${cy_package_name}/${cxy}_${cy_package_name}_${dy_package_name}/admin/${ay_table_name_module}/${ay_table_name_child}/del_all.do";
...
function delRecord(id){
	if(confirm("确定要删除吗？"))
	{
		var url = "${ay_s}{pageContext.request.contextPath}/${cxy}/${cy_package_name}/${cxy}_${cy_package_name}_${dy_package_name}/admin/${ay_table_name_module}/${ay_table_name_child}/del.do?id="+id;
...
function updateRecord(id){
	var url= "${ay_s}{pageContext.request.contextPath}/${cxy}/${cy_package_name}/${cxy}_${cy_package_name}_${dy_package_name}/admin/${ay_table_name_module}/${ay_table_name_child}/form.do?id="+id;
 	window.location.href=url;
}
/**
 * 
 ...
 */
function newRecord(){
 	var url= "${ay_s}{pageContext.request.contextPath}/${cxy}/${cy_package_name}/${cxy}_${cy_package_name}_${dy_package_name}/admin/${ay_table_name_module}/${ay_table_name_child}/form.do";
 	window.location.href=url;
}
	</script>