...
public class TransactionBase2 {
	...
	private static DataSourceUtil jdbcDataSourceLocal = null;
	private static IJdbcTool jdbcToolLocal = null;
	private static IJdbcUtil jdbcUtilLocal = null;
	private static TransactionBase2 instance = null;
	private final static Object key = new Object();
	/**
	 * 私有的默认构造函数
	 */
	private TransactionBase2() {
	}
	public static TransactionBase2 findInstance() {
		if (instance == null) {
			synchronized (key) {
				if (instance == null) {
					instance = new TransactionBase2();
					initJdbcToolLocal();
				}
			}
		}
	 ...
	 * @throws Exception
	 */
	public IJdbcTool findJdbcToolLocal() throws SQLException, Exception {
		Connection connectionLocal = jdbcDataSourceLocal.findConnection();
		jdbcUtilLocal.setConnection(connectionLocal);
		// 需要ThreadLocal
	 ...
	 * @throws Exception
	 */
	public static IJdbcTool initJdbcToolLocal() {
		try {
