...
import c.a.util.core.jdbc.oracle.PageOracleBean;
...
public class JdbcOracleTool extends JdbcCoreTool implements IJdbcTool {
	private IJdbcUtil JdbcUtil = new JdbcOracleUtil();
	/**
	 * 
	 * 1
	 *
	...
	@Override public PageCoreBean<Map<String, Object>> findPageBean(Class classObj,
		...
		for (Map<String, Object> map : listMapCount) {
			...
			for (String key : set) {
				if (key.equals(JdbcNutUtil.ROW_NUM)) {
					// 跳过序列编号;
					continue;
				}
		...
		if (page.isFindAll()) {
			...
			String sqlFinal = jdbcUtil.findSqlPage(sql, start, end, pageIndex,
					pageSize);
			listObject = this.findObjectList(classObj, conn, sqlFinal,
					parameterList);
			// }
			// 设置参数
		}
	...
	@Override public PageCoreBean<Map<String, Object>> findPageBean(Class c_Class,
			...
			List<Object> parameterListCount, String sqlPage,
			List<Object> parameterListPage) throws Exception {
		PageCoreBean<Map<String, Object>> pageBean = new PageOracleBean<>(pageNo, pageSize);
		return this.findPageBean(c_Class, conn, pageBean, sql, parameterList,
				sqlCount, parameterListCount, sqlPage, parameterListPage);
	}
	/**
	...
	@Override public PageCoreBean<Map<String, Object>> findPageBean(Class c_Class,
			...
			String sqlCount, List<Object> parameterListCount, String sqlPage,
			List<Object> parameterListPage) throws Exception {
		PageCoreBean page = new PageOracleBean(1, Integer.MAX_VALUE);
