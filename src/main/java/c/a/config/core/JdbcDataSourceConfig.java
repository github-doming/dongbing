 ...
 * 
 */
public class JdbcDataSourceConfig extends CharsetConfigAy{
	// 日志
	...
	// 单例
	private static JdbcDataSourceConfig instance = null;
	// key 最好用Object
	// private final static String key = "key";
	private final static Object key = new Object();
	private JdbcDataSourceConfig() {
	}
	public static JdbcDataSourceConfig findInstance() throws Exception {
		synchronized (key) {
			if (instance == null) {
				instance = new JdbcDataSourceConfig();
				init();
			}
		}
		return instance;
