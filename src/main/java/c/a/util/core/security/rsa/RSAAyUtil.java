package c.a.util.core.security.rsa;
 ...
 * @Description:
 * @ClassName: RSAAyUtil
 * @date 2018年7月18日 下午1:03:50
 * @author cxy
 * @Email: 
 * @Copyright (c) 1995-2095 本源代码受软件著作法保护，请在授权允许范围内使用。
 *
 */
public class RSAAyUtil extends BASE64Util {
	 ...
	 * @throws Exception
	 */
	public byte[] decodeByPublicKey(byte[] data, String key) throws Exception {
		// 对密钥解密
		byte[] keyBytes = decodeBASE64(key);
		// 取得公钥
	 ...
	 * @throws Exception
	 */
	public byte[] encodeByPrivateKey(byte[] data, String key) throws Exception {
		// 对密钥解密
		byte[] keyBytes = decodeBASE64(key);
		// 取得私钥
		PKCS8EncodedKeySpec pkcs8KeySpec = new PKCS8EncodedKeySpec(keyBytes);
	 ...
	 * @throws Exception
	 */
	public String findPrivateKey(Map<String, Object> keyMap) throws Exception {
	 ...
	 * @throws Exception
	 */
	public String findPublicKey(Map<String, Object> keyMap) throws Exception {
