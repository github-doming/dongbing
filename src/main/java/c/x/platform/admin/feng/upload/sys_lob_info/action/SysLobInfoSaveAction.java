...
public class SysLobInfoSaveAction extends BaseAction {
	@Override
	public String execute() throws Exception {
		...
		// 得到上传文件
		Map map = uploadUtil.findFile(this.servletContext, request, response);
		if (map != null) {
			// 文件字段
			...
			// 是普通的字段
			String fileName = request.getParameter("sys_lob_info.file_name");
