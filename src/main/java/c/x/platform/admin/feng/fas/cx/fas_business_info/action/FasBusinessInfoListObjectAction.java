...
import c.x.platform.admin.feng.fas.cx.fas_business_info.service.FasBusinessInfoService_listObject;
...
public class FasBusinessInfoListObjectAction extends BaseAction {
	@Override
	public String execute() throws Exception {
		...
		FasBusinessInfoService_listObject service = new FasBusinessInfoService_listObject();
		PageCoreBean<FasBusinessInfo> pageBean = service.find(sortOrderName, sortFieldName, pageNo, pageSize);
		List<FasBusinessInfo> listMap = pageBean.getList();
