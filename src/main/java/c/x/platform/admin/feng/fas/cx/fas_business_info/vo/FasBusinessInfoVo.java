package c.x.platform.admin.feng.fas.cx.fas_business_info.vo;
import java.io.Serializable;
/**
 * The vo class for the database table fas_business_info vo类
 */
public class FasBusinessInfoVo implements Serializable {
