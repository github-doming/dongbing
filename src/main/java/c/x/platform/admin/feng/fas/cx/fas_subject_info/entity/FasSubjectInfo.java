package c.x.platform.admin.feng.fas.cx.fas_subject_info.entity;
...
/**
 * The persistent class for the database table fas_subject_info 实体类
 */
@AnnotationEntity
@AnnotationTable(name = "fas_subject_info")
public class FasSubjectInfo implements Serializable {
