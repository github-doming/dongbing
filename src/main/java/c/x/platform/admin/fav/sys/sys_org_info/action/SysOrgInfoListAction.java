...
public class SysOrgInfoListAction extends BaseTreeTableAction {
	@Override
	public TreeTableParameter initParameter() throws Exception {
		...
		treeTableParameter
				.setSql("select * from sys_org t1 order by t1.sequence asc,t1.id asc");
	...
	public Map<String, Object> tds() throws Exception {
		...
		for (Map<String, Object> jsonMap : listMap) {
			...
			// 排序
			sb.append("<td>");
			sb.append((Integer) jsonMap.get("sequence"));
			sb.append("</td>");
			// 操作
			sb.append("<td>");
			// sb.append("abc");
