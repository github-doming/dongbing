...
public class FunSingleSimpleGenTreeSimpleParentAction extends CommTreeTableAction {
	@Override
	public TreeTableParameter initParameter() throws Exception {
		...
		treeTableParameter.setSql("select * from fun_single_simple t1 ");
	...
	public Map<String, Object> tds() throws Exception {
		...
		for (Map<String, Object> entityMap : listMap) {
			sb.setLength(0);
			// id
			String id = (String) entityMap.get("FUN_SINGLE_SIMPLE_ID_");
			// 名称
			if (false) {
				sb.append("<td>");
