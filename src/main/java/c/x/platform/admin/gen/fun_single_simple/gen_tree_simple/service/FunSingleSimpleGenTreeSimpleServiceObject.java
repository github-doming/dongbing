...
public class FunSingleSimpleGenTreeSimpleServiceObject extends BaseService {
	protected Logger log = LogManager.getLogger(this.getClass());
	public FunSingleSimpleGenTreeSimple find(String id) throws Exception {
		return (FunSingleSimpleGenTreeSimple) this.dao.find(FunSingleSimpleGenTreeSimple.class, id);
	}

	public void update(FunSingleSimpleGenTreeSimple entity) throws Exception {
		dao.update(entity);
		// 更新所有节点的path
		FunSingleSimpleGenTreeSimple parent = this.find(entity.getParent().toString());
	...
	public void del(String id) throws Exception {
		...
		sb.append("  select path FROM  fun_single_simple where FUN_SINGLE_SIMPLE_ID_= ");
		sb.append(id);
		String sql_query = sb.toString();
		FunSingleSimpleGenTreeSimple parent = (FunSingleSimpleGenTreeSimple) dao.findObject(
				FunSingleSimpleGenTreeSimple.class, sql_query, null);
		String parent_path = parent.getPath();
		// 清空 StringBuilder
		sb.setLength(0);
		// 删除所有孩子
		sb.append(" delete  from fun_single_simple where path like ?");
	 ...
	 * @throws Exception
	 */
	public List<FunSingleSimpleGenTreeSimple> findAll() throws Exception {

		String sql = "SELECT * FROM fun_single_simple order by FUN_SINGLE_SIMPLE_ID_ desc";
		List<FunSingleSimpleGenTreeSimple> list = this.dao.findObjectList(FunSingleSimpleGenTreeSimple.class, sql);
