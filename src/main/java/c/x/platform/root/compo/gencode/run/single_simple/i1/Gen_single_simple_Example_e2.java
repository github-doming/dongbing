...
public class Gen_single_simple_Example_e2 extends CommTest {
	@Test
	public void execute() {
		// 数据库设置
		...
		try {
			...
			if (true) {
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_log_notify");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_project_info");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_invest_result");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_log_resp");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_account");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_acc_balance");
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_trade_status");
			}
			if (true) {
				gen.gen_singleSimple(final_folderPath, "config.mvc.wsd.gen", "wsd.gen", "wsd.gen", "cx",
						"thirdbank_config");
