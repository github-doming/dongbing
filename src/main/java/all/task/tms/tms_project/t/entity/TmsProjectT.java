package all.task.tms.tms_project.t.entity;
...
public class TmsProjectT implements Serializable {
	...
	private List<TmsProjectT > children;
	public List<TmsProjectT> getChildren() {
		return children;
	}
	public void setChildren(List<TmsProjectT> children) {
