...
public class TmsFunctionTParentAction extends CommTreeTableAction {
	@Override
	public TreeTableParameter initParameter() throws Exception {
		...
		treeTableParameter.setSql("select * from tms_function t1 where state_!='DEL'");
