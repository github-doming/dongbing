package all.gen.app_log_request.t.entity;
...
/**
 * The persistent class for the database table app_log_request 
 * APP日志_请求报文APP_LOG_REQUEST的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "app_log_request")
public class AppLogRequestT implements Serializable {
...
//APP日志_请求主键APP_LOG_REQUEST_ID_
@Column(name="APP_LOG_REQUEST_ID")
	private String appLogRequestId;
	
	public void setAppLogRequestId(String appLogRequestId) {
		this.appLogRequestId=appLogRequestId;
	}
	public String getAppLogRequestId() {
		return this.appLogRequestId ;
	}
