package all.gen.alipay_log_return.t.entity;
...
/**
 * The persistent class for the database table alipay_log_return 
 * 支付宝支付日志_异步_接口返回ALIPAY_LOG_RETURN的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "alipay_log_return")
public class AlipayLogReturnT implements Serializable {
...
@Column(name="ALIPAY_LOG_RETURN_ID_")
