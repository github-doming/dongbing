package all.gen.cms_msg_topic.t.entity;
...
/**
 * The persistent class for the database table cms_msg_topic 
 * CMS_消息主题CMS_MSG_TOPIC的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "cms_msg_topic")
public class CmsMsgTopicT implements Serializable {
