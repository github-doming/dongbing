package all.gen.cms_msg_topic.t.service;
...
public class CmsMsgTopicTService extends BaseService {
	...
	public void del(String id) throws Exception {
		...
		String sql = "update cms_msg_topic set state_='DEL' where CMS_MSG_TOPIC_ID_=?";
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update cms_msg_topic set state_='DEL' where CMS_MSG_TOPIC_ID_ in("
...
/**
	...
	public PageCoreBean<Map<String, Object>> find(String sortFieldName, String sortOrderName,
		...
		if (StringUtil.isBlank(sortFieldName)
			...
			sql_count = "SELECT count(*) FROM cms_msg_topic where state_!='DEL'";
			sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by UPDATE_TIME_ desc";
		} else {

			sql_count = "SELECT count(*) FROM cms_msg_topic where state_!='DEL'";
			sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by " + sortFieldName
					+ " " + sortOrderName;
		}
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<CmsMsgTopicT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
	...
	public List<Map<String, Object>> findAll() throws Exception {
		//String sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by CMS_MSG_TOPIC_ID_ desc";
		
		String sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by UPDATE_TIME_ desc";
	 ...
	 * @throws Exception
	 */
	public List<CmsMsgTopicT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by CMS_MSG_TOPIC_ID_ desc";
		String sql = "SELECT * FROM cms_msg_topic  where state_!='DEL' order by UPDATE_TIME_ desc";
