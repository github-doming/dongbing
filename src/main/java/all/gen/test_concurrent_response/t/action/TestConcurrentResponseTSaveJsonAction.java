...
public class TestConcurrentResponseTSaveJsonAction extends BaseAction {
	@Override
	public String execute() throws Exception {
		...
		entity = (TestConcurrentResponseT) RequestThreadLocal.doRequest2EntityByJson(TestConcurrentResponseTVo.class, TestConcurrentResponseT.class, request);
