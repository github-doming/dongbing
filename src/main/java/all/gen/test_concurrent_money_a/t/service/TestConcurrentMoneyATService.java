...
public class TestConcurrentMoneyATService extends BaseService {
	...
	public void del(String id) throws Exception {
		...
		String sql = "update test_concurrent_money_a set state_='DEL' where TEST_CONCURRENT_MONEY_A_ID_=?";
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update test_concurrent_money_a set state_='DEL' where TEST_CONCURRENT_MONEY_A_ID_ in("
...
/**
	...
	public PageCoreBean<Map<String, Object>> find(String sortFieldName, String sortOrderName,
		...
		if (StringUtil.isBlank(sortFieldName)
			...
			sql_count = "SELECT count(*) FROM test_concurrent_money_a where state_!='DEL'";
			sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by UPDATE_TIME_ desc";
		} else {

			sql_count = "SELECT count(*) FROM test_concurrent_money_a where state_!='DEL'";
			sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by " + sortFieldName
					+ " " + sortOrderName;
		}
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<TestConcurrentMoneyAT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
	...
	public List<Map<String, Object>> findAll() throws Exception {
		//String sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by TEST_CONCURRENT_MONEY_A_ID_ desc";
		
		String sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by UPDATE_TIME_ desc";
	 ...
	 * @throws Exception
	 */
	public List<TestConcurrentMoneyAT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by TEST_CONCURRENT_MONEY_A_ID_ desc";
		String sql = "SELECT * FROM test_concurrent_money_a  where state_!='DEL' order by UPDATE_TIME_ desc";
