package all.gen.sys_group_menu.t.entity;
...
/**
 * The persistent class for the database table sys_group_menu 
 * 后台用户组与菜单SYS_GROUP_MENU的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "sys_group_menu")
public class SysGroupMenuT implements Serializable {
...
//SYS_GROUP_MENU_ID_
@Column(name="SYS_GROUP_MENU_ID_")
