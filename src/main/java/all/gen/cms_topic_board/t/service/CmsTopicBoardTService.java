...
public class CmsTopicBoardTService extends BaseService {
	...
	public void del(String id) throws Exception {
		...
		String sql = "update cms_topic_board set state_='DEL' where CMS_TOPIC_BOARD_ID_=?";
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update cms_topic_board set state_='DEL' where CMS_TOPIC_BOARD_ID_ in("
...
/**
	...
	public PageCoreBean<Map<String, Object>> find(String sortFieldName, String sortOrderName,
		...
		if (StringUtil.isBlank(sortFieldName)
			...
			sql_count = "SELECT count(*) FROM cms_topic_board where state_!='DEL'";
			sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by UPDATE_TIME_ desc";
		} else {

			sql_count = "SELECT count(*) FROM cms_topic_board where state_!='DEL'";
			sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by " + sortFieldName
					+ " " + sortOrderName;
		}
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<CmsTopicBoardT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
	...
	public List<Map<String, Object>> findAll() throws Exception {
		//String sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by CMS_TOPIC_BOARD_ID_ desc";
		
		String sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by UPDATE_TIME_ desc";
	 ...
	 * @throws Exception
	 */
	public List<CmsTopicBoardT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by CMS_TOPIC_BOARD_ID_ desc";
		String sql = "SELECT * FROM cms_topic_board  where state_!='DEL' order by UPDATE_TIME_ desc";
