package all.gen.alipay_log_notify.t.entity;
...
/**
 * The persistent class for the database table alipay_log_notify 
 * 支付宝支付日志_异步_接口通知ALIPAY_LOG_NOTIFY的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "alipay_log_notify")
public class AlipayLogNotifyT implements Serializable {
