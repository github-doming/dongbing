package all.gen.fun_type_str.t.entity;
...
/**
 * The persistent class for the database table fun_type_str 
 * 例子FUN_TYPE_STR的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "fun_type_str")
public class FunTypeStrT implements Serializable {
...
//FUN_TYPE_STR_ID_
@Column(name="FUN_TYPE_STR_ID_")
	private String funTypeStrId;
	
	public void setFunTypeStrId(String funTypeStrId) {
		this.funTypeStrId=funTypeStrId;
	}
	public String getFunTypeStrId() {
		return this.funTypeStrId ;
	}
