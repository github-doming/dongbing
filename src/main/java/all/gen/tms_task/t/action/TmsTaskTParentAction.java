...
public class TmsTaskTParentAction extends CommTreeTableAction {
	@Override
	public TreeTableParameter initParameter() throws Exception {
		...
		treeTableParameter.setSql("select * from tms_task t1 where state_!='DEL'");
	...
	public Map<String, Object> tds() throws SQLException {
		...
		for (Map<String, Object> entityMap : listMap) {
			sb.setLength(0);
			// id
			String id = (String) entityMap.get("TMS_TASK_ID_");
			// 名称
			if (false) {
				sb.append("<td>");
