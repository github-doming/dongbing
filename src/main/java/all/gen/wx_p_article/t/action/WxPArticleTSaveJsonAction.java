...
public class WxPArticleTSaveJsonAction extends BaseAction {
	@Override
	public String execute() throws Exception {
		WxPArticleTService service = new WxPArticleTService();
		WxPArticleT entity = null;
		String id = request.getParameter("id");
		entity = (WxPArticleT) RequestThreadLocal.doRequest2EntityByJson(WxPArticleTVo.class, WxPArticleT.class, request);
