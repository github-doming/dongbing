...
public class TestConcurrentRequestTSaveJsonAction extends BaseAction {
	@Override
	public String execute() throws Exception {
		TestConcurrentRequestTService service = new TestConcurrentRequestTService();
		TestConcurrentRequestT entity = null;
		String id = request.getParameter("id");
		entity = (TestConcurrentRequestT) RequestThreadLocal.doRequest2EntityByJson(TestConcurrentRequestTVo.class, TestConcurrentRequestT.class, request);
