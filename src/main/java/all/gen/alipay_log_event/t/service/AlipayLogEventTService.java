...
public class AlipayLogEventTService extends BaseService {
	...
	public void del(String id) throws Exception {
		...
		String sql = "update alipay_log_event set state_='DEL' where ALIPAY_LOG_EVENT_ID_=?";
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update alipay_log_event set state_='DEL' where ALIPAY_LOG_EVENT_ID_ in("
...
/**
	...
	public PageCoreBean<Map<String, Object>> find(String sortFieldName, String sortOrderName,
		...
		if (StringUtil.isBlank(sortFieldName)
			...
			sql_count = "SELECT count(*) FROM alipay_log_event where state_!='DEL'";
			sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by UPDATE_TIME_ desc";
		} else {

			sql_count = "SELECT count(*) FROM alipay_log_event where state_!='DEL'";
			sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by " + sortFieldName
					+ " " + sortOrderName;
		}
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<AlipayLogEventT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
	...
	public List<Map<String, Object>> findAll() throws Exception {
		//String sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by ALIPAY_LOG_EVENT_ID_ desc";
		
		String sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by UPDATE_TIME_ desc";
	 ...
	 * @throws Exception
	 */
	public List<AlipayLogEventT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by ALIPAY_LOG_EVENT_ID_ desc";
		String sql = "SELECT * FROM alipay_log_event  where state_!='DEL' order by UPDATE_TIME_ desc";
