package all.app_admin.app.app_menu.t.service;
...
/**
	...
	public String findParent(String string) throws SQLException {
		String sql="select APP_MENU_ID_ FROM app_menu where APP_MENU_NAME_=?";
		List<Object> parameterList = new ArrayList<>();
		parameterList.add(string);
		return dao.findString("APP_MENU_ID_", sql, parameterList);
	}
}
