...
public class AppUserJqgridListJsonAction extends CommAction {
	...
	public String execute() throws Exception {
		...
		PageCoreBean<Map<String, Object>> page = service.find(this.findCurrentAppUser(), sortOrderName, sortFieldName,
				pageIndex, pageSize);
