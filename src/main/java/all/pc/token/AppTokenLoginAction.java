	...
	public String run() throws Exception {
		...
		try {
			...
			if (false) {
				...
				String verifyCodeSession = redisUtil.findAppVerifyCode(jedis, sessionId);
			}
			...
			// login
			AppTokenT appTokenT = appService.loginByPC(this.findCurrentUserTenantCode(), this.request, this.response,
