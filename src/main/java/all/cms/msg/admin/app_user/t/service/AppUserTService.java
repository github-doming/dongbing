package all.cms.msg.admin.app_user.t.service;
...
public class AppUserTService extends BaseService {
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update app_user set state_='DEL' where APP_USER_ID_ in("
...
/**
	...
	public void delAllPhysical(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			stringBuffer.deleteCharAt(stringBuffer.length() - 1);
			String sql = "delete from app_user where APP_USER_ID_ in("
				+ stringBuffer.toString() + ")";
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<AppUserT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
		...
		PageCoreBean<AppUserT> basePage = dao.page(AppUserT.class,
	 ...
	 * @throws Exception
	 */
	public List<AppUserT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM app_user  where state_!='DEL' order by APP_USER_ID_ desc";
		String sql = "SELECT * FROM app_user  where state_!='DEL' order by UPDATE_TIME_ desc";
		List<AppUserT> list = this.dao.findObjectList(AppUserT.class, sql);
