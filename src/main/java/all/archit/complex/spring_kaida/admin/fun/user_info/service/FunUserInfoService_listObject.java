...
public class FunUserInfoService_listObject extends BaseService {
	/**
	 * 
	 * 查找实体
	 * 
	...
	public SpringKaidaFunUserInfo find(String id) throws Exception {
		return (SpringKaidaFunUserInfo) this.dao.find(SpringKaidaFunUserInfo.class, id);
	}
	/**
	 * 
	 * 更新
	...
	public void delAll(String[] ids) throws Exception {
		...
		String sql = "delete from sys_user_info where id in(" + stringBuffer.toString() + ")";
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<SpringKaidaFunUserInfo> find(String sortOrderName, String sortFieldName, Integer pageIndex,
		...
		PageCoreBean<SpringKaidaFunUserInfo> pageBean = dao.page(SpringKaidaFunUserInfo.class, sql, null,
	...
	public List<SpringKaidaFunUserInfo> listAll() throws Exception {
		...
		List<SpringKaidaFunUserInfo> list = this.dao.findObjectList(SpringKaidaFunUserInfo.class, sql);
		return list;
	}
}
