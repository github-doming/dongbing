...
public class ActwfBusinessDefTService extends BaseService {
	...
	public void del(String id) throws Exception {
		...
		String sql = "update actwf_business_def set state_='DEL' where ACTWF_BUSINESS_DEF_ID_=?";
	...
	public void delAll(String[] idArray) throws Exception {
		if(idArray!=null){
			...
			String sql = "update actwf_business_def set state_='DEL' where ACTWF_BUSINESS_DEF_ID_ in("
...
/**
	...
	public PageCoreBean<Map<String, Object>> find(String sortFieldName, String sortOrderName,
		...
		if (StringUtil.isBlank(sortFieldName)
			...
			sql_count = "SELECT count(*) FROM actwf_business_def where state_!='DEL'";
			sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by UPDATE_TIME_ desc";
		} else {

			sql_count = "SELECT count(*) FROM actwf_business_def where state_!='DEL'";
			sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by " + sortFieldName
					+ " " + sortOrderName;
		}
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<ActwfBusinessDefT> findObject(String sortFieldName, String sortOrderName,
			Integer pageIndex, Integer pageSize) throws Exception {
		String sql_count = null;
		String sql = null;
	...
	public List<Map<String, Object>> findAll() throws Exception {
		//String sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by ACTWF_BUSINESS_DEF_ID_ desc";
		
		String sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by UPDATE_TIME_ desc";
	 ...
	 * @throws Exception
	 */
	public List<ActwfBusinessDefT> findObjectAll() throws Exception {
		//String sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by ACTWF_BUSINESS_DEF_ID_ desc";
		String sql = "SELECT * FROM actwf_business_def  where state_!='DEL' order by UPDATE_TIME_ desc";
