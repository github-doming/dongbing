package all.sys_admin.sys.sys_group_user.cx.service;
...
public class SysGroupUserService extends BaseService {
	...
	public void delAll(String[] ids) throws Exception {
		if (ids != null) {
			...
			String sql = "delete from SYS_GROUP_USER  where ID_ in(" + stringBuffer.toString() + ")";
	...
	public PageCoreBean<Map<String, Object>> find(String sortOrderName, String sortFieldName, Integer pageIndex,
		...
		if (StringUtil.isBlank(sortOrderName) || StringUtil.isBlank(sortFieldName)) {
			...
			sql_count = "SELECT count(*) from SYS_GROUP_USER  ";
			sql = "SELECT * from SYS_GROUP_USER  order by " + sortFieldName + " " + sortOrderName;
		}
