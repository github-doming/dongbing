...
public class SysAccountService extends BaseService {
	...
	public boolean isUserByName(String name) throws Exception {
		String sql = "select NAME_ FROM SYS_ACCOUNT where SYS_ACCOUNT_NAME_=?";
	 ...
	 * @throws Exception
	 */
	public PageCoreBean<Map<String, Object>> find( CurrentSysUser  currentUser,String sortFieldName, String sortOrderName, Integer pageIndex,
		...
		if (StringUtil.isBlank(sortFieldName) || StringUtil.isBlank(sortOrderName)) {
			...
			sql = "SELECT * FROM SYS_ACCOUNT where PERMISSION_GRADE_>=? order by SYS_ACCOUNT_ID_ desc";
		} else {

			sql_count = "SELECT count(*) FROM SYS_ACCOUNT ";
			sql = "SELECT * FROM SYS_ACCOUNT where PERMISSION_GRADE_>=? order by " + sortFieldName + " " + sortOrderName;
		}
