...
/**
 * @Description: 保存跟投会员设置
 * @Author: null
 * @Date: 2019-11-28 17:52
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/app/agent/followMemberSet", method = HttpConfig.Method.POST)
public class FollowMemberSetAction extends CommCoreAction {
