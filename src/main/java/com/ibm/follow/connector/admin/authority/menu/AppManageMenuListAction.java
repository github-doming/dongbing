 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/admin/authority/menu/manageList")
public class AppManageMenuListAction extends CommAdminAction {
	@Override
	public Object run() throws Exception {
		...
		try {
			...
			List<Map<String,Object>> menu = authorityService.listManageUserMenus(adminUser.getUserId(),"1");
			for(Map<String,Object> map : menu){
				map.put("subMenu",authorityService.listManageUserMenus(adminUser.getUserId(), (String) map.get("id")));
			}
