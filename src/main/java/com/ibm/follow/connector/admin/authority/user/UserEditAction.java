 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/admin/authority/user/edit") public class UserEditAction extends CommAdminAction {

	String userName, userId, userPassWord, roleId, state;
	@Override public Object run() throws Exception {
		...
		try {
			...
			if (StringTool.notEmpty(roleId)){
				Map<String, Object> role = authorityService.findRole(roleId,adminUser.getUserId());
			...
			authorityService.updateUser(userName,state,userId,adminUser.getUserId());
