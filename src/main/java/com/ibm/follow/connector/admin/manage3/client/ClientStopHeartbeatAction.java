 ...
 * @Description: 客户机停止心跳
 * @Author: null
 * @Date: 2020-03-03 13:25
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/admin/manage/client/stopHeartbeat1", method = HttpConfig.Method.GET)
public class ClientStopHeartbeatAction extends CommAdminAction {
    @Override
...
//        }
        ...
        content.put("methodType", IbmMethodEnum.CLOSE.name());
