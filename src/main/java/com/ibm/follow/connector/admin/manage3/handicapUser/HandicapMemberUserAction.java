...
/**
 * @Description: 盘口会员用户列表
 * @Author: lxl
 * @Date: 2019-10-14 11:09
 * @Email: 2543908257@qq.com
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/admin/manage/handicap/memberUser")
public class HandicapMemberUserAction extends CommAdminAction {
    ...
    public Object run() throws Exception {
        ...
        if (StringTool.isEmpty(HandicapUtil.Code.value(handicapCode))) {
            log.error(" 查询 盘口会员列表  出错");
        }
        Map<String,Object> map = new HashMap<>(1);
        List<Map<String,Object>> mapList = new ArrayList<>();
        try{
            List<Map<String,Object>> maps = new IbmHmUserService().findUserAll();
            ...
            map.put("memberUsers",mapList);
            map.put("codes", codes);
        }catch (Exception e){
            log.info("查询 盘口会员列表 失败");
        }
        return new ModelAndView("/pages/com/ibm/admin/manager/handicapUser/handicapMemberUser.jsp",map);
    }
