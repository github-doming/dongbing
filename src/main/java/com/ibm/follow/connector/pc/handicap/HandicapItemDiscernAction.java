 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/pc/handicap/itemDiscern", method = HttpConfig.Method.GET) public class HandicapItemDiscernAction
	...
	@Override public Object run() throws Exception {
		...
		try {
			...
			log.error(IbmMainConfig.LOG_SIGN.concat("识别盘口失败")+e.getMessage());
