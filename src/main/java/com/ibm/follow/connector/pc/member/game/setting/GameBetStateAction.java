 ...
 * @Author: zjj
 * @Date: 2019-09-09 14:49
 * @Email: 543974681@qq.com
 * @Version: v1.0
 */
@ActionMapping(value = "/ibm/pc/member/gameBetState", method = HttpConfig.Method.POST)
public class GameBetStateAction extends CommCoreAction {
	...
	@Override public Object run() throws Exception {
		...
		try {
			...
			log.error(IbmMainConfig.LOG_SIGN.concat("修改游戏投注状态失败")+e.getMessage());
	...
	private void saveHmLog(IbmHmGameSet hmGameSet) throws Exception {
		...
		logHm.setHandleContent("BET_STATE_".concat(hmGameSet.getBetState()));
