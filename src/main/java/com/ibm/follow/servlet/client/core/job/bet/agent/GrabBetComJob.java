...
/**
 * @Description: 抓取COM盘口投注项
 * @Author: null
 * @Date: 2020-04-27 18:11
 * @Version: v1.0
 */
public class GrabBetComJob extends GrabBetJob {
    ...
    private void execute() throws Exception {
        ...
        //盘口时间字符串
		String date =handicapCode.getMemberFactory().handicap().handicapPeriod(gameCode).toString();
        // 获取跟投会员的未结算摘要信息
    ...
    private void putBetMap(ComAgentUtil agentUtil, Map<String,double[][]> betMap, SummaryInfo summaryInfo, String date) {
