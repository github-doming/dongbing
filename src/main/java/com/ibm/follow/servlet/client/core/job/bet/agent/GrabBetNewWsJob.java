...
import com.ibm.common.utils.http.utils.agent.NewWsAgentUtil;
...
/**
 * @Description: 抓取UN盘口投注项
 * @Author: null
 * @Date: 2020-04-27 18:11
 * @Version: v1.0
 */
public class GrabBetNewWsJob extends GrabBetJob {
    ...
    private void execute() throws Exception {
        ...
        // 获取跟投会员的未结算摘要信息
        NewWsAgentUtil agentUtil= NewWsAgentUtil.findInstance();
    ...
    private void putBetMap(NewWsAgentUtil agentUtil, Map<String,double[][]> betMap, SummaryInfo summaryInfo, String date) {
