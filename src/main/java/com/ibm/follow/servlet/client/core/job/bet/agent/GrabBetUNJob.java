...
import com.ibm.common.utils.http.utils.agent.UNAgentUtil;
 ...
 * @Version: v1.0
 */
public class GrabBetUNJob extends GrabBetJob {
	...
	public void executeJob(JobExecutionContext context) throws Exception {
		handicapCode = HandicapUtil.Code.UN;
	...
	private void execute() throws Exception {
		...
		// 获取跟投会员的未结算摘要信息
		UNAgentUtil agentUtil = UNAgentUtil.findInstance();
	...
	private void putBetMap(UNAgentUtil agentUtil, Map<String, double[][]> betMap, SummaryInfo summaryInfo, String date) {
