package com.ibm.follow.servlet.client.ibmc_exist_hm.entity;
...
/**
 * The persistent class for the database table ibmc_exist_hm 
 * IBMC客户端_已存在盘口会员的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibmc_exist_hm")
public class IbmcExistHm implements Serializable {
	...
	@Column(name="IBMC_EXIST_HM_ID_")
	private String ibmcExistHmId;
	public void setIbmcExistHmId(String ibmcExistHmId) {
		this.ibmcExistHmId=ibmcExistHmId;
	}
	public void setIbmcExistHmId(Object ibmcExistHmId) {
		if (ibmcExistHmId != null) {
			this.ibmcExistHmId = ibmcExistHmId.toString();
		}else{
			this.ibmcExistHmId = null;
		}
	}
	public String getIbmcExistHmId() {
		return this.ibmcExistHmId ;
	}
