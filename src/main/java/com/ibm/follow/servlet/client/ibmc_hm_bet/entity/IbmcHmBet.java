package com.ibm.follow.servlet.client.ibmc_hm_bet.entity;
...
/**
 * The persistent class for the database table ibmc_hm_bet 
 * IBMC客户端_会员投注的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibmc_hm_bet")
public class IbmcHmBet implements Serializable {
	...
	@Column(name="IBMC_HM_BET_ID_")
	private String ibmcHmBetId;
	public void setIbmcHmBetId(String ibmcHmBetId) {
		this.ibmcHmBetId=ibmcHmBetId;
	}
	public void setIbmcHmBetId(Object ibmcHmBetId) {
		if (ibmcHmBetId != null) {
			this.ibmcHmBetId = ibmcHmBetId.toString();
		}else{
			this.ibmcHmBetId = null;
		}
	}
	public String getIbmcHmBetId() {
		return this.ibmcHmBetId ;
	}
	 ...
	 * IBMC客户端_代理跟随投注主键
	 */
	@Column(name="HA_FOLLOW_BET_ID_")
	private String haFollowBetId;
	public void setHaFollowBetId(String haFollowBetId) {
		this.haFollowBetId=haFollowBetId;
	}
	public void setHaFollowBetId(Object haFollowBetId) {
		if (haFollowBetId != null) {
			this.haFollowBetId = haFollowBetId.toString();
		}else{
			this.haFollowBetId = null;
		}
	}
	public String getHaFollowBetId() {
		return this.haFollowBetId ;
	}
