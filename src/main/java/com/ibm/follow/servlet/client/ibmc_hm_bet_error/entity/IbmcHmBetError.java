package com.ibm.follow.servlet.client.ibmc_hm_bet_error.entity;
...
/**
 * The persistent class for the database table ibmc_hm_bet_error 
 * IBMC客户端_会员投注异常的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibmc_hm_bet_error")
public class IbmcHmBetError implements Serializable {
	...
	@Column(name="IBMC_HM_BET_ERROR_ID_")
	private String ibmcHmBetErrorId;
	public void setIbmcHmBetErrorId(String ibmcHmBetErrorId) {
		this.ibmcHmBetErrorId=ibmcHmBetErrorId;
	}
	public void setIbmcHmBetErrorId(Object ibmcHmBetErrorId) {
		if (ibmcHmBetErrorId != null) {
			this.ibmcHmBetErrorId = ibmcHmBetErrorId.toString();
		}else{
			this.ibmcHmBetErrorId = null;
		}
	}
	public String getIbmcHmBetErrorId() {
		return this.ibmcHmBetErrorId ;
	}
