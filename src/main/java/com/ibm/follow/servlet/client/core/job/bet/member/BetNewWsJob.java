...
/**
 * @Description: NewWs投注工作类
 * @Author: Dongming
 * @Date: 2019-09-12 16:47
 * @Email: job.dongming@foxmail.com
 * @Version: v1.0
 */
public class BetNewWsJob extends BetJob {
	...
	private void betProcess() throws Exception {
		...
		for (Map.Entry<String, Object> entry : hmBetMap.entrySet()) {
			...
			for (String info : betInfos) {
				...
				//保存投注信息
				BetJobDefine.NewWsSaveBetInfo(betItemMap, fundMap, hmBetIdMap, items, entry.getKey(),gameCode.name());
			}
		}
