package com.ibm.follow.servlet.client.ibmc_config.entity;
...
/**
 * The persistent class for the database table ibmc_config 
 * IBMC客户端_配置的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibmc_config")
public class IbmcConfig implements Serializable {

	private static final long serialVersionUID = 1L;

	/**
	 * IBMC_客户端配置主键IBMC_CONFIG_ID_
	 * 根据底层数据库
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="IBMC_CONFIG_ID_")
	private String ibmcConfigId;
	public void setIbmcConfigId(String ibmcConfigId) {
		this.ibmcConfigId=ibmcConfigId;
	}
	public void setIbmcConfigId(Object ibmcConfigId) {
		if (ibmcConfigId != null) {
			this.ibmcConfigId = ibmcConfigId.toString();
		}else{
			this.ibmcConfigId = null;
		}
	}
	public String getIbmcConfigId() {
		return this.ibmcConfigId ;
	}
