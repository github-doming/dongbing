...
/**
 * @Description: 新com1投注job
 * @Author: null
 * @Date: 2019-12-27 14:47
 * @Version: v1.0
 */
public class BetNcom1Job extends BetJob {

    @Override
    public void executeJob(JobExecutionContext context) throws Exception {
        try {
            handicapCode=HandicapUtil.Code.NCOM1;
            ...
            //处理投注信息
            betProcess();
            log.info("定时投注Ncom1盘口用户【" + existHmId + "】游戏【" + gameCode + "】期数【" + period + "】投注完成");
        } catch (Exception e) {
            log.error("定时投注Ncom1盘口用户【" + existHmId + "】游戏【" + gameCode + "】期数【" + period + "】异常:" + e.getMessage());
            throw e;
        }
    }
    /**
