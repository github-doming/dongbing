package com.ibm.follow.servlet.server.core.job.service;
...
public class MigrateService extends BaseService {
	 ...
	 * @param tableNames  表名
	 */
	public void delData(List<String> tableNames) throws SQLException {
		String sql = "DELETE FROM %s where STATE_ is NUll";
		for (String tableName : tableNames) {
			super.dao.execute(String.format(sql, tableName), null);
		}
	}
