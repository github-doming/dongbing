package com.ibm.follow.servlet.cloud.vr_plan_game.entity;
...
/**
 * The persistent class for the database table vr_plan_game 
 * VR_方案游戏 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vr_plan_game")
public class VrPlanGame implements Serializable {
	...
	@Column(name="VR_PLAN_GAME_ID_")
	private String vrPlanGameId;
	public void setVrPlanGameId(String vrPlanGameId) {
		this.vrPlanGameId=vrPlanGameId;
	}
	public void setVrPlanGameId(Object vrPlanGameId) {
		if (vrPlanGameId != null) {
			this.vrPlanGameId = vrPlanGameId.toString();
		}
	}
	public String getVrPlanGameId() {
		return this.vrPlanGameId ;
	}
