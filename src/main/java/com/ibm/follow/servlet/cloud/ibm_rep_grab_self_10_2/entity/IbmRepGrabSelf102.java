package com.ibm.follow.servlet.cloud.ibm_rep_grab_self_10_2.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_self_10_2 
 * IBM_抓取数据_自有赛车两分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_self_10_2")
public class IbmRepGrabSelf102 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_SELF_10_2_ID_")
	private String ibmRepGrabSelf102Id;
	public void setIbmRepGrabSelf102Id(String ibmRepGrabSelf102Id) {
		this.ibmRepGrabSelf102Id=ibmRepGrabSelf102Id;
	}
	public void setIbmRepGrabSelf102Id(Object ibmRepGrabSelf102Id) {
		if (ibmRepGrabSelf102Id != null) {
			this.ibmRepGrabSelf102Id = ibmRepGrabSelf102Id.toString();
		}
	}
	public String getIbmRepGrabSelf102Id() {
		return this.ibmRepGrabSelf102Id ;
	}

	/**
	 * 结果数据_自有赛车两分彩主键
	 */
	@Column(name="REP_DRAW_SELF_10_2_ID_")
	private String repDrawSelf102Id;
	public void setRepDrawSelf102Id(String repDrawSelf102Id) {
		this.repDrawSelf102Id=repDrawSelf102Id;
	}
	public void setRepDrawSelf102Id(Object repDrawSelf102Id) {
		if (repDrawSelf102Id != null) {
			this.repDrawSelf102Id = repDrawSelf102Id.toString();
		}
	}
	public String getRepDrawSelf102Id() {
		return this.repDrawSelf102Id ;
	}
