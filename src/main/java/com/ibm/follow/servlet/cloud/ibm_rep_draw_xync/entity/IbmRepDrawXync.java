package com.ibm.follow.servlet.cloud.ibm_rep_draw_xync.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_xync 
 * IBM_结果数据_幸运农场 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_xync")
public class IbmRepDrawXync implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_XYNC_ID_")
	private String ibmRepDrawXyncId;
	public void setIbmRepDrawXyncId(String ibmRepDrawXyncId) {
		this.ibmRepDrawXyncId=ibmRepDrawXyncId;
	}
	public void setIbmRepDrawXyncId(Object ibmRepDrawXyncId) {
		if (ibmRepDrawXyncId != null) {
			this.ibmRepDrawXyncId = ibmRepDrawXyncId.toString();
		}
	}
	public String getIbmRepDrawXyncId() {
		return this.ibmRepDrawXyncId ;
	}

	/**
	 * 抓取数据_幸运农场主键
	 */
	@Column(name="REP_GRAB_XYNC_ID_")
	private String repGrabXyncId;
	public void setRepGrabXyncId(String repGrabXyncId) {
		this.repGrabXyncId=repGrabXyncId;
	}
	public void setRepGrabXyncId(Object repGrabXyncId) {
		if (repGrabXyncId != null) {
			this.repGrabXyncId = repGrabXyncId.toString();
		}
	}
	public String getRepGrabXyncId() {
		return this.repGrabXyncId ;
	}
