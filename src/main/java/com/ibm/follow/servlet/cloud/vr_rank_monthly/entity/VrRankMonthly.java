package com.ibm.follow.servlet.cloud.vr_rank_monthly.entity;
...
/**
 * The persistent class for the database table vr_rank_monthly 
 * VR_月度榜单 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vr_rank_monthly")
public class VrRankMonthly implements Serializable {
	...
	@Column(name="VR_RANK_MONTHLY_ID_")
	private String vrRankMonthlyId;
	public void setVrRankMonthlyId(String vrRankMonthlyId) {
		this.vrRankMonthlyId=vrRankMonthlyId;
	}
	public void setVrRankMonthlyId(Object vrRankMonthlyId) {
		if (vrRankMonthlyId != null) {
			this.vrRankMonthlyId = vrRankMonthlyId.toString();
		}
	}
	public String getVrRankMonthlyId() {
		return this.vrRankMonthlyId ;
	}
