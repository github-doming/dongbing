package com.ibm.follow.servlet.cloud.ibm_rep_grab_self_ssc_5.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_self_ssc_5 
 * IBM_抓取数据_自有时时彩5分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_self_ssc_5")
public class IbmRepGrabSelfSsc5 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_SELF_SSC_5_ID_")
	private String ibmRepGrabSelfSsc5Id;
	public void setIbmRepGrabSelfSsc5Id(String ibmRepGrabSelfSsc5Id) {
		this.ibmRepGrabSelfSsc5Id=ibmRepGrabSelfSsc5Id;
	}
	public void setIbmRepGrabSelfSsc5Id(Object ibmRepGrabSelfSsc5Id) {
		if (ibmRepGrabSelfSsc5Id != null) {
			this.ibmRepGrabSelfSsc5Id = ibmRepGrabSelfSsc5Id.toString();
		}
	}
	public String getIbmRepGrabSelfSsc5Id() {
		return this.ibmRepGrabSelfSsc5Id ;
	}

	/**
	 * 结果数据_自有时时彩5分彩主键
	 */
	@Column(name="REP_DRAW_SELF_SSC_5_ID_")
	private String repDrawSelfSsc5Id;
	public void setRepDrawSelfSsc5Id(String repDrawSelfSsc5Id) {
		this.repDrawSelfSsc5Id=repDrawSelfSsc5Id;
	}
	public void setRepDrawSelfSsc5Id(Object repDrawSelfSsc5Id) {
		if (repDrawSelfSsc5Id != null) {
			this.repDrawSelfSsc5Id = repDrawSelfSsc5Id.toString();
		}
	}
	public String getRepDrawSelfSsc5Id() {
		return this.repDrawSelfSsc5Id ;
	}
