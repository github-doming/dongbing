package com.ibm.follow.servlet.cloud.ibm_rep_grab_country_10.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_country_10 
 * IBM_抓取数据_国家赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_country_10")
public class IbmRepGrabCountry10 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_COUNTRY_10_ID_")
	private String ibmRepGrabCountry10Id;
	public void setIbmRepGrabCountry10Id(String ibmRepGrabCountry10Id) {
		this.ibmRepGrabCountry10Id=ibmRepGrabCountry10Id;
	}
	public void setIbmRepGrabCountry10Id(Object ibmRepGrabCountry10Id) {
		if (ibmRepGrabCountry10Id != null) {
			this.ibmRepGrabCountry10Id = ibmRepGrabCountry10Id.toString();
		}
	}
	public String getIbmRepGrabCountry10Id() {
		return this.ibmRepGrabCountry10Id ;
	}

	/**
	 * 结果数据_国家赛车主键
	 */
	@Column(name="REP_DRAW_COUNTRY_10_ID_")
	private String repDrawCountry10Id;
	public void setRepDrawCountry10Id(String repDrawCountry10Id) {
		this.repDrawCountry10Id=repDrawCountry10Id;
	}
	public void setRepDrawCountry10Id(Object repDrawCountry10Id) {
		if (repDrawCountry10Id != null) {
			this.repDrawCountry10Id = repDrawCountry10Id.toString();
		}
	}
	public String getRepDrawCountry10Id() {
		return this.repDrawCountry10Id ;
	}
