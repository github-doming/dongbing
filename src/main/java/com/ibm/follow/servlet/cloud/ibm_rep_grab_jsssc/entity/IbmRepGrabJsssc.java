package com.ibm.follow.servlet.cloud.ibm_rep_grab_jsssc.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_jsssc 
 * IBM_抓取数据_急速时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_jsssc")
public class IbmRepGrabJsssc implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_JSSSC_ID_")
	private String ibmRepGrabJssscId;
	public void setIbmRepGrabJssscId(String ibmRepGrabJssscId) {
		this.ibmRepGrabJssscId=ibmRepGrabJssscId;
	}
	public void setIbmRepGrabJssscId(Object ibmRepGrabJssscId) {
		if (ibmRepGrabJssscId != null) {
			this.ibmRepGrabJssscId = ibmRepGrabJssscId.toString();
		}
	}
	public String getIbmRepGrabJssscId() {
		return this.ibmRepGrabJssscId ;
	}

	/**
	 * 结果数据_重庆时时彩主键
	 */
	@Column(name="REP_DRAW_JSSSC_ID_")
	private String repDrawJssscId;
	public void setRepDrawJssscId(String repDrawJssscId) {
		this.repDrawJssscId=repDrawJssscId;
	}
	public void setRepDrawJssscId(Object repDrawJssscId) {
		if (repDrawJssscId != null) {
			this.repDrawJssscId = repDrawJssscId.toString();
		}
	}
	public String getRepDrawJssscId() {
		return this.repDrawJssscId ;
	}
