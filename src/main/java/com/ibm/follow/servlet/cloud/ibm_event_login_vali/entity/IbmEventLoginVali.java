package com.ibm.follow.servlet.cloud.ibm_event_login_vali.entity;
...
/**
 * The persistent class for the database table ibm_event_login_vali 
 * IBM_盘口会员验证登录事件的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_event_login_vali")
public class IbmEventLoginVali implements Serializable {
	...
	@Column(name="IBM_EVENT_LOGIN_VALI_ID_")
	private String ibmEventLoginValiId;
	public void setIbmEventLoginValiId(String ibmEventLoginValiId) {
		this.ibmEventLoginValiId=ibmEventLoginValiId;
	}
	public void setIbmEventLoginValiId(Object ibmEventLoginValiId) {
		if (ibmEventLoginValiId != null) {
			this.ibmEventLoginValiId = ibmEventLoginValiId.toString();
		}else{
			this.ibmEventLoginValiId = null;
		}
	}
	public String getIbmEventLoginValiId() {
		return this.ibmEventLoginValiId ;
	}
