package com.ibm.follow.servlet.cloud.ibm_cms_announce.entity;
...
/**
 * The persistent class for the database table ibm_cms_announce 
 * IBM消息公告 IBM_CMS_ANNOUNCE 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_cms_announce")
public class IbmCmsAnnounce implements Serializable {
	...
	@Column(name="IBM_CMS_ANNOUNCE_ID_")
	private String ibmCmsAnnounceId;
	public void setIbmCmsAnnounceId(String ibmCmsAnnounceId) {
		this.ibmCmsAnnounceId=ibmCmsAnnounceId;
	}
	public void setIbmCmsAnnounceId(Object ibmCmsAnnounceId) {
		if (ibmCmsAnnounceId != null) {
			this.ibmCmsAnnounceId = ibmCmsAnnounceId.toString();
		}
	}
	public String getIbmCmsAnnounceId() {
		return this.ibmCmsAnnounceId ;
	}
