package com.ibm.follow.servlet.cloud.ibm_hm_notice.entity;
...
/**
 * The persistent class for the database table ibm_hm_notice 
 * IBM_盘口会员通知的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_hm_notice")
public class IbmHmNotice implements Serializable {
	...
	@Column(name="IBM_HM_NOTICE_ID_")
	private String ibmHmNoticeId;
	public void setIbmHmNoticeId(String ibmHmNoticeId) {
		this.ibmHmNoticeId=ibmHmNoticeId;
	}
	public void setIbmHmNoticeId(Object ibmHmNoticeId) {
		if (ibmHmNoticeId != null) {
			this.ibmHmNoticeId = ibmHmNoticeId.toString();
		}else{
			this.ibmHmNoticeId = null;
		}
	}
	public String getIbmHmNoticeId() {
		return this.ibmHmNoticeId ;
	}
