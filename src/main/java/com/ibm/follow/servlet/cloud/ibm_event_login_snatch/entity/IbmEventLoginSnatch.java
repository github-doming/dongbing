package com.ibm.follow.servlet.cloud.ibm_event_login_snatch.entity;
...
/**
 * The persistent class for the database table ibm_event_login_snatch 
 * IBM_盘口会员抢占登录事件的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_event_login_snatch")
public class IbmEventLoginSnatch implements Serializable {
	...
	@Column(name="IBM_EVENT_LOGIN_SNATCH_ID_")
	private String ibmEventLoginSnatchId;
	public void setIbmEventLoginSnatchId(String ibmEventLoginSnatchId) {
		this.ibmEventLoginSnatchId=ibmEventLoginSnatchId;
	}
	public void setIbmEventLoginSnatchId(Object ibmEventLoginSnatchId) {
		if (ibmEventLoginSnatchId != null) {
			this.ibmEventLoginSnatchId = ibmEventLoginSnatchId.toString();
		}else{
			this.ibmEventLoginSnatchId = null;
		}
	}
	public String getIbmEventLoginSnatchId() {
		return this.ibmEventLoginSnatchId ;
	}
