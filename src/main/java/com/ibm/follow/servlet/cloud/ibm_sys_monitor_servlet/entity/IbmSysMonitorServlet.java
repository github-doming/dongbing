package com.ibm.follow.servlet.cloud.ibm_sys_monitor_servlet.entity;
...
/**
 * The persistent class for the database table ibm_sys_monitor_servlet 
 * IBM_服务器监控信息 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_sys_monitor_servlet")
public class IbmSysMonitorServlet implements Serializable {
	...
	@Column(name="IBM_SYS_MONITOR_SERVLET_ID_")
	private String ibmSysMonitorServletId;
	public void setIbmSysMonitorServletId(String ibmSysMonitorServletId) {
		this.ibmSysMonitorServletId=ibmSysMonitorServletId;
	}
	public void setIbmSysMonitorServletId(Object ibmSysMonitorServletId) {
		if (ibmSysMonitorServletId != null) {
			this.ibmSysMonitorServletId = ibmSysMonitorServletId.toString();
		}
	}
	public String getIbmSysMonitorServletId() {
		return this.ibmSysMonitorServletId ;
	}
