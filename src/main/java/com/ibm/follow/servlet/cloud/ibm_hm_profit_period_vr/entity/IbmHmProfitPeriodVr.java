package com.ibm.follow.servlet.cloud.ibm_hm_profit_period_vr.entity;
...
/**
 * The persistent class for the database table ibm_hm_profit_period_vr 
 * IBM_盘口会员当期模拟盈亏的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_hm_profit_period_vr")
public class IbmHmProfitPeriodVr implements Serializable {
	...
	@Column(name="IBM_HM_PROFIT_PERIOD_VR_ID_")
	private String ibmHmProfitPeriodVrId;
	public void setIbmHmProfitPeriodVrId(String ibmHmProfitPeriodVrId) {
		this.ibmHmProfitPeriodVrId=ibmHmProfitPeriodVrId;
	}
	public void setIbmHmProfitPeriodVrId(Object ibmHmProfitPeriodVrId) {
		if (ibmHmProfitPeriodVrId != null) {
			this.ibmHmProfitPeriodVrId = ibmHmProfitPeriodVrId.toString();
		}else{
			this.ibmHmProfitPeriodVrId = null;
		}
	}
	public String getIbmHmProfitPeriodVrId() {
		return this.ibmHmProfitPeriodVrId ;
	}
