package com.ibm.follow.servlet.cloud.ibm_log_hm.entity;
...
/**
 * The persistent class for the database table ibm_log_hm 
 * IBM_盘口会员操作日志IBM_LOG_HM的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_log_hm")
public class IbmLogHm implements Serializable {

	private static final long serialVersionUID = 1L;

	/**
	 * IBM_盘口会员操作日志表主键IBM_LOG_HM_ID_
	 * 根据底层数据库
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="IBM_LOG_HM_ID_")
	private String ibmLogHmId;
	public void setIbmLogHmId(String ibmLogHmId) {
		this.ibmLogHmId=ibmLogHmId;
	}
	public void setIbmLogHmId(Object ibmLogHmId) {
		if (ibmLogHmId != null) {
			this.ibmLogHmId = ibmLogHmId.toString();
		}else{
			this.ibmLogHmId = null;
		}
	}
	public String getIbmLogHmId() {
		return this.ibmLogHmId ;
	}
