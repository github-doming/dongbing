package com.ibm.follow.servlet.cloud.ibm_log_monitor_client.entity;
...
/**
 * The persistent class for the database table ibm_log_monitor_client 
 * IBM_客户端详情日志 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_log_monitor_client")
public class IbmLogMonitorClient implements Serializable {
	...
	@Column(name="IBM_LOG_MONITOR_CLIENT_ID_")
	private String ibmLogMonitorClientId;
	public void setIbmLogMonitorClientId(String ibmLogMonitorClientId) {
		this.ibmLogMonitorClientId=ibmLogMonitorClientId;
	}
	public void setIbmLogMonitorClientId(Object ibmLogMonitorClientId) {
		if (ibmLogMonitorClientId != null) {
			this.ibmLogMonitorClientId = ibmLogMonitorClientId.toString();
		}
	}
	public String getIbmLogMonitorClientId() {
		return this.ibmLogMonitorClientId ;
	}
