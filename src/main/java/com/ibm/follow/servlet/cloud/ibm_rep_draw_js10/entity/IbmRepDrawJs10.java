package com.ibm.follow.servlet.cloud.ibm_rep_draw_js10.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_js10 
 * IBM_结果数据_急速赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_js10")
public class IbmRepDrawJs10 implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_JS10_ID_")
	private String ibmRepDrawJs10Id;
	public void setIbmRepDrawJs10Id(String ibmRepDrawJs10Id) {
		this.ibmRepDrawJs10Id=ibmRepDrawJs10Id;
	}
	public void setIbmRepDrawJs10Id(Object ibmRepDrawJs10Id) {
		if (ibmRepDrawJs10Id != null) {
			this.ibmRepDrawJs10Id = ibmRepDrawJs10Id.toString();
		}
	}
	public String getIbmRepDrawJs10Id() {
		return this.ibmRepDrawJs10Id ;
	}

	/**
	 * 抓取数据_急速赛车主键
	 */
	@Column(name="REP_GRAB_JS10_ID_")
	private String repGrabJs10Id;
	public void setRepGrabJs10Id(String repGrabJs10Id) {
		this.repGrabJs10Id=repGrabJs10Id;
	}
	public void setRepGrabJs10Id(Object repGrabJs10Id) {
		if (repGrabJs10Id != null) {
			this.repGrabJs10Id = repGrabJs10Id.toString();
		}
	}
	public String getRepGrabJs10Id() {
		return this.repGrabJs10Id ;
	}
