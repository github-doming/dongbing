package com.ibm.follow.servlet.cloud.ibm_rep_grab_js10.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_js10 
 * IBM_抓取数据_急速赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_js10")
public class IbmRepGrabJs10 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_JS10_ID_")
	private String ibmRepGrabJs10Id;
	public void setIbmRepGrabJs10Id(String ibmRepGrabJs10Id) {
		this.ibmRepGrabJs10Id=ibmRepGrabJs10Id;
	}
	public void setIbmRepGrabJs10Id(Object ibmRepGrabJs10Id) {
		if (ibmRepGrabJs10Id != null) {
			this.ibmRepGrabJs10Id = ibmRepGrabJs10Id.toString();
		}
	}
	public String getIbmRepGrabJs10Id() {
		return this.ibmRepGrabJs10Id ;
	}

	/**
	 * 结果数据_急速赛车主键
	 */
	@Column(name="REP_DRAW_JS10_ID_")
	private String repDrawJs10Id;
	public void setRepDrawJs10Id(String repDrawJs10Id) {
		this.repDrawJs10Id=repDrawJs10Id;
	}
	public void setRepDrawJs10Id(Object repDrawJs10Id) {
		if (repDrawJs10Id != null) {
			this.repDrawJs10Id = repDrawJs10Id.toString();
		}
	}
	public String getRepDrawJs10Id() {
		return this.repDrawJs10Id ;
	}
