package com.ibm.follow.servlet.cloud.ibm_manage_point.entity;
...
/**
 * The persistent class for the database table ibm_manage_point 
 * IBM_用户点数的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_manage_point")
public class IbmManagePoint implements Serializable {
	...
	@Column(name="IBM_MANAGE_POINT_ID_")
	private String ibmManagePointId;
	public void setIbmManagePointId(String ibmManagePointId) {
		this.ibmManagePointId=ibmManagePointId;
	}
	public void setIbmManagePointId(Object ibmManagePointId) {
		if (ibmManagePointId != null) {
			this.ibmManagePointId = ibmManagePointId.toString();
		}
	}
	public String getIbmManagePointId() {
		return this.ibmManagePointId ;
	}
