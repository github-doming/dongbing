package com.ibm.follow.servlet.cloud.ibm_event_config_info.entity;
...
/**
 * The persistent class for the database table ibm_event_config_info 
 * IBM_客户端设置事件的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_event_config_info")
public class IbmEventConfigInfo implements Serializable {
	...
	@Column(name="IBM_EVENT_CONFIG_INFO_ID_")
	private String ibmEventConfigInfoId;
	public void setIbmEventConfigInfoId(String ibmEventConfigInfoId) {
		this.ibmEventConfigInfoId=ibmEventConfigInfoId;
	}
	public void setIbmEventConfigInfoId(Object ibmEventConfigInfoId) {
		if (ibmEventConfigInfoId != null) {
			this.ibmEventConfigInfoId = ibmEventConfigInfoId.toString();
		}else{
			this.ibmEventConfigInfoId = null;
		}
	}
	public String getIbmEventConfigInfoId() {
		return this.ibmEventConfigInfoId ;
	}
	 ...
	 * 事件内容
	 */
	@Column(name="EVENT_METHOD_")
	private String eventMethod;
	public void setEventMethod(String eventMethod) {
		this.eventMethod=eventMethod;
	}
	public void setEventMethod(Object eventMethod) {
		if (eventMethod != null) {
			this.eventMethod = eventMethod.toString();
		}else{
