package com.ibm.follow.servlet.cloud.ibm_rep_draw_self_10_2.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_self_10_2 
 * IBM_结果数据_自有赛车两分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_self_10_2")
public class IbmRepDrawSelf102 implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_SELF_10_2_ID_")
	private String ibmRepDrawSelf102Id;
	public void setIbmRepDrawSelf102Id(String ibmRepDrawSelf102Id) {
		this.ibmRepDrawSelf102Id=ibmRepDrawSelf102Id;
	}
	public void setIbmRepDrawSelf102Id(Object ibmRepDrawSelf102Id) {
		if (ibmRepDrawSelf102Id != null) {
			this.ibmRepDrawSelf102Id = ibmRepDrawSelf102Id.toString();
		}
	}
	public String getIbmRepDrawSelf102Id() {
		return this.ibmRepDrawSelf102Id ;
	}

	/**
	 * 抓取数据_自有赛车两分彩主键
	 */
	@Column(name="REP_GRAB_SELF_10_2_ID_")
	private String repGrabSelf102Id;
	public void setRepGrabSelf102Id(String repGrabSelf102Id) {
		this.repGrabSelf102Id=repGrabSelf102Id;
	}
	public void setRepGrabSelf102Id(Object repGrabSelf102Id) {
		if (repGrabSelf102Id != null) {
			this.repGrabSelf102Id = repGrabSelf102Id.toString();
		}
	}
	public String getRepGrabSelf102Id() {
		return this.repGrabSelf102Id ;
	}
