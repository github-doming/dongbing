package com.ibm.follow.servlet.cloud.ibm_rep_draw_jsssc.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_jsssc 
 * IBM_结果数据_急速时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_jsssc")
public class IbmRepDrawJsssc implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_JSSSC_ID_")
	private String ibmRepDrawJssscId;
	public void setIbmRepDrawJssscId(String ibmRepDrawJssscId) {
		this.ibmRepDrawJssscId=ibmRepDrawJssscId;
	}
	public void setIbmRepDrawJssscId(Object ibmRepDrawJssscId) {
		if (ibmRepDrawJssscId != null) {
			this.ibmRepDrawJssscId = ibmRepDrawJssscId.toString();
		}
	}
	public String getIbmRepDrawJssscId() {
		return this.ibmRepDrawJssscId ;
	}

	/**
	 * 抓取数据_重庆时时彩主键
	 */
	@Column(name="REP_GRAB_JSSSC_ID_")
	private String repGrabJssscId;
	public void setRepGrabJssscId(String repGrabJssscId) {
		this.repGrabJssscId=repGrabJssscId;
	}
	public void setRepGrabJssscId(Object repGrabJssscId) {
		if (repGrabJssscId != null) {
			this.repGrabJssscId = repGrabJssscId.toString();
		}
	}
	public String getRepGrabJssscId() {
		return this.repGrabJssscId ;
	}
