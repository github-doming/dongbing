package com.ibm.follow.servlet.cloud.ibm_sys_thread_pool.entity;
 ...
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_sys_thread_pool")
public class IbmSysThreadPool implements Serializable {
	...
	@Column(name="IBM_SYS_THREAD_POOL_ID_")
	private String ibmSysThreadPoolId;
	public void setIbmSysThreadPoolId(String ibmSysThreadPoolId) {
		this.ibmSysThreadPoolId=ibmSysThreadPoolId;
	}
	public void setIbmSysThreadPoolId(Object ibmSysThreadPoolId) {
		if (ibmSysThreadPoolId != null) {
			this.ibmSysThreadPoolId = ibmSysThreadPoolId.toString();
		}
	}
	public String getIbmSysThreadPoolId() {
		return this.ibmSysThreadPoolId ;
	}
