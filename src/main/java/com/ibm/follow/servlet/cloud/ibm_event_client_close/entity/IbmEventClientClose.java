package com.ibm.follow.servlet.cloud.ibm_event_client_close.entity;
...
/**
 * The persistent class for the database table ibm_event_client_close 
 * IBM_关闭客户端事件的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_event_client_close")
public class IbmEventClientClose implements Serializable {
	...
	@Column(name="IBM_EVENT_CLIENT_CLOSE_ID_")
	private String ibmEventClientCloseId;
	public void setIbmEventClientCloseId(String ibmEventClientCloseId) {
		this.ibmEventClientCloseId=ibmEventClientCloseId;
	}
	public void setIbmEventClientCloseId(Object ibmEventClientCloseId) {
		if (ibmEventClientCloseId != null) {
			this.ibmEventClientCloseId = ibmEventClientCloseId.toString();
		}else{
			this.ibmEventClientCloseId = null;
		}
	}
	public String getIbmEventClientCloseId() {
		return this.ibmEventClientCloseId ;
	}
