package com.ibm.follow.servlet.cloud.ibm_rep_grab_gdklc.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_gdklc 
 * IBM_抓取数据_广东快乐十分 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_gdklc")
public class IbmRepGrabGdklc implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_GDKLC_ID_")
	private String ibmRepGrabGdklcId;
	public void setIbmRepGrabGdklcId(String ibmRepGrabGdklcId) {
		this.ibmRepGrabGdklcId=ibmRepGrabGdklcId;
	}
	public void setIbmRepGrabGdklcId(Object ibmRepGrabGdklcId) {
		if (ibmRepGrabGdklcId != null) {
			this.ibmRepGrabGdklcId = ibmRepGrabGdklcId.toString();
		}
	}
	public String getIbmRepGrabGdklcId() {
		return this.ibmRepGrabGdklcId ;
	}

	/**
	 * 结果数据_广东快乐十分主键
	 */
	@Column(name="REP_DRAW_GDKLC_ID_")
	private String repDrawGdklcId;
	public void setRepDrawGdklcId(String repDrawGdklcId) {
		this.repDrawGdklcId=repDrawGdklcId;
	}
	public void setRepDrawGdklcId(Object repDrawGdklcId) {
		if (repDrawGdklcId != null) {
			this.repDrawGdklcId = repDrawGdklcId.toString();
		}
	}
	public String getRepDrawGdklcId() {
		return this.repDrawGdklcId ;
	}
