package com.ibm.follow.servlet.cloud.ibm_event_login.entity;
...
/**
 * The persistent class for the database table ibm_event_login 
 * IBM_盘口会员登录事件的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_event_login")
public class IbmEventLogin implements Serializable {
	...
	@Column(name="IBM_EVENT_LOGIN_ID_")
	private String ibmEventLoginId;
	public void setIbmEventLoginId(String ibmEventLoginId) {
		this.ibmEventLoginId=ibmEventLoginId;
	}
	public void setIbmEventLoginId(Object ibmEventLoginId) {
		if (ibmEventLoginId != null) {
			this.ibmEventLoginId = ibmEventLoginId.toString();
		}else{
			this.ibmEventLoginId = null;
		}
	}
	public String getIbmEventLoginId() {
		return this.ibmEventLoginId ;
	}
