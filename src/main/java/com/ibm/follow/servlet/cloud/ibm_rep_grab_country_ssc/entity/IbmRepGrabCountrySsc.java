package com.ibm.follow.servlet.cloud.ibm_rep_grab_country_ssc.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_country_ssc 
 * IBM_抓取数据_国家时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_country_ssc")
public class IbmRepGrabCountrySsc implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_COUNTRY_SSC_ID_")
	private String ibmRepGrabCountrySscId;
	public void setIbmRepGrabCountrySscId(String ibmRepGrabCountrySscId) {
		this.ibmRepGrabCountrySscId=ibmRepGrabCountrySscId;
	}
	public void setIbmRepGrabCountrySscId(Object ibmRepGrabCountrySscId) {
		if (ibmRepGrabCountrySscId != null) {
			this.ibmRepGrabCountrySscId = ibmRepGrabCountrySscId.toString();
		}
	}
	public String getIbmRepGrabCountrySscId() {
		return this.ibmRepGrabCountrySscId ;
	}

	/**
	 * 结果数据_国家时时彩主键
	 */
	@Column(name="REP_DRAW_COUNTRY_SSC_ID_")
	private String repDrawCountrySscId;
	public void setRepDrawCountrySscId(String repDrawCountrySscId) {
		this.repDrawCountrySscId=repDrawCountrySscId;
	}
	public void setRepDrawCountrySscId(Object repDrawCountrySscId) {
		if (repDrawCountrySscId != null) {
			this.repDrawCountrySscId = repDrawCountrySscId.toString();
		}
	}
	public String getRepDrawCountrySscId() {
		return this.repDrawCountrySscId ;
	}
