package com.ibm.follow.servlet.cloud.ibm_rep_draw_pk10.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_pk10 
 * 北京赛车PK10_结果数据的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_pk10")
public class IbmRepDrawPk10 implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_PK10_ID_")
	private String ibmRepDrawPk10Id;
	public void setIbmRepDrawPk10Id(String ibmRepDrawPk10Id) {
		this.ibmRepDrawPk10Id=ibmRepDrawPk10Id;
	}
	public void setIbmRepDrawPk10Id(Object ibmRepDrawPk10Id) {
		if (ibmRepDrawPk10Id != null) {
			this.ibmRepDrawPk10Id = ibmRepDrawPk10Id.toString();
		}else{
			this.ibmRepDrawPk10Id = null;
		}
	}
	public String getIbmRepDrawPk10Id() {
		return this.ibmRepDrawPk10Id ;
	}

	/**
	 * 北京赛车PK10_抓取数据
	 */
	@Column(name="REP_GRAB_PK10_ID_")
	private String repGrabPk10Id;
	public void setRepGrabPk10Id(String repGrabPk10Id) {
		this.repGrabPk10Id=repGrabPk10Id;
	}
	public void setRepGrabPk10Id(Object repGrabPk10Id) {
		if (repGrabPk10Id != null) {
			this.repGrabPk10Id = repGrabPk10Id.toString();
		}else{
			this.repGrabPk10Id = null;
		}
	}
	public String getRepGrabPk10Id() {
		return this.repGrabPk10Id ;
	}
	...
	public void setChampionSumNunmberEn(Object championSumNunmberEn) {
		if (championSumNunmberEn != null) {
			...
			this.championSumNunmberEn = null;
		}
	}
