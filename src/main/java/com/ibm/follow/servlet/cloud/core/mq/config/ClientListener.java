...
import com.ibm.follow.servlet.cloud.core.controller.process.ClientHandicapMigrateController;
import com.ibm.follow.servlet.cloud.core.controller.process.ClientInfoController;
import com.ibm.follow.servlet.cloud.core.controller.process.ClientReplaceController;
import com.ibm.follow.servlet.cloud.core.controller.process.HandicapCapacityDelController;
    ...
    @Override public String execute(String message) throws Exception {
        ...
        try {
            ...
            switch (command) {
                ...
                case SEAL_TIME:
                case HEARTBEAT:
                    execute=new ClientInfoController();
                    break;
                case CLIENT_MIGRATE:
                    execute=new ClientHandicapMigrateController();
                    break;
                case REPLACE:
