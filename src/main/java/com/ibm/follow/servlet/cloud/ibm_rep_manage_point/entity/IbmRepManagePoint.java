package com.ibm.follow.servlet.cloud.ibm_rep_manage_point.entity;
...
/**
 * The persistent class for the database table ibm_rep_manage_point 
 * IBM_点数使用情况的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_manage_point")
public class IbmRepManagePoint implements Serializable {
	...
	@Column(name="IBM_REP_MANAGE_POINT_ID_")
	private String ibmRepManagePointId;
	public void setIbmRepManagePointId(String ibmRepManagePointId) {
		this.ibmRepManagePointId=ibmRepManagePointId;
	}
	public void setIbmRepManagePointId(Object ibmRepManagePointId) {
		if (ibmRepManagePointId != null) {
			this.ibmRepManagePointId = ibmRepManagePointId.toString();
		}
	}
	public String getIbmRepManagePointId() {
		return this.ibmRepManagePointId ;
	}
