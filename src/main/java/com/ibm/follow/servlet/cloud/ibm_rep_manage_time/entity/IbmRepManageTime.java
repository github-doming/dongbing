package com.ibm.follow.servlet.cloud.ibm_rep_manage_time.entity;
...
/**
 * The persistent class for the database table ibm_rep_manage_time 
 * IBM_可用时长情况的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_manage_time")
public class IbmRepManageTime implements Serializable {
	...
	@Column(name="IBM_REP_MANAGE_TIME_ID_")
	private String ibmRepManageTimeId;
	public void setIbmRepManageTimeId(String ibmRepManageTimeId) {
		this.ibmRepManageTimeId=ibmRepManageTimeId;
	}
	public void setIbmRepManageTimeId(Object ibmRepManageTimeId) {
		if (ibmRepManageTimeId != null) {
			this.ibmRepManageTimeId = ibmRepManageTimeId.toString();
		}
	}
	public String getIbmRepManageTimeId() {
		return this.ibmRepManageTimeId ;
	}
