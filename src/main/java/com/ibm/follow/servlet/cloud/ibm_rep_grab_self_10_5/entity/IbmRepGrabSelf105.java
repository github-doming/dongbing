package com.ibm.follow.servlet.cloud.ibm_rep_grab_self_10_5.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_self_10_5 
 * IBM_抓取数据_自有赛车五分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_self_10_5")
public class IbmRepGrabSelf105 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_SELF_10_5_ID_")
	private String ibmRepGrabSelf105Id;
	public void setIbmRepGrabSelf105Id(String ibmRepGrabSelf105Id) {
		this.ibmRepGrabSelf105Id=ibmRepGrabSelf105Id;
	}
	public void setIbmRepGrabSelf105Id(Object ibmRepGrabSelf105Id) {
		if (ibmRepGrabSelf105Id != null) {
			this.ibmRepGrabSelf105Id = ibmRepGrabSelf105Id.toString();
		}
	}
	public String getIbmRepGrabSelf105Id() {
		return this.ibmRepGrabSelf105Id ;
	}

	/**
	 * 结果数据_自有赛车五分彩主键
	 */
	@Column(name="REP_DRAW_SELF_10_5_ID_")
	private String repDrawSelf105Id;
	public void setRepDrawSelf105Id(String repDrawSelf105Id) {
		this.repDrawSelf105Id=repDrawSelf105Id;
	}
	public void setRepDrawSelf105Id(Object repDrawSelf105Id) {
		if (repDrawSelf105Id != null) {
			this.repDrawSelf105Id = repDrawSelf105Id.toString();
		}
	}
	public String getRepDrawSelf105Id() {
		return this.repDrawSelf105Id ;
	}
