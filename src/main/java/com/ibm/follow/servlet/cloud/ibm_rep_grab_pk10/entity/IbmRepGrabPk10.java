package com.ibm.follow.servlet.cloud.ibm_rep_grab_pk10.entity;
...
/**
 * The persistent class for the database table ibm_rep_grab_pk10 
 * 北京赛车PK10_抓取数据IBM_REP_GRAB_PK10的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_grab_pk10")
public class IbmRepGrabPk10 implements Serializable {
	...
	@Column(name="IBM_REP_GRAB_PK10_ID_")
	private String ibmRepGrabPk10Id;
	public void setIbmRepGrabPk10Id(String ibmRepGrabPk10Id) {
		this.ibmRepGrabPk10Id=ibmRepGrabPk10Id;
	}
	public void setIbmRepGrabPk10Id(Object ibmRepGrabPk10Id) {
		if (ibmRepGrabPk10Id != null) {
			this.ibmRepGrabPk10Id = ibmRepGrabPk10Id.toString();
		}else{
			this.ibmRepGrabPk10Id = null;
		}
	}
	public String getIbmRepGrabPk10Id() {
		return this.ibmRepGrabPk10Id ;
	}

	/**
	 * 北京赛车PK10_结果数据
	 */
	@Column(name="REP_DRAW_PK10_ID_")
	private String repDrawPk10Id;
	public void setRepDrawPk10Id(String repDrawPk10Id) {
		this.repDrawPk10Id=repDrawPk10Id;
	}
	public void setRepDrawPk10Id(Object repDrawPk10Id) {
		if (repDrawPk10Id != null) {
			this.repDrawPk10Id = repDrawPk10Id.toString();
		}else{
			this.repDrawPk10Id = null;
		}
	}
	public String getRepDrawPk10Id() {
		return this.repDrawPk10Id ;
	}
