package com.ibm.follow.servlet.cloud.ibm_rep_draw_country_10.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_country_10 
 * IBM_结果数据_国家赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_country_10")
public class IbmRepDrawCountry10 implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_COUNTRY_10_ID_")
	private String ibmRepDrawCountry10Id;
	public void setIbmRepDrawCountry10Id(String ibmRepDrawCountry10Id) {
		this.ibmRepDrawCountry10Id=ibmRepDrawCountry10Id;
	}
	public void setIbmRepDrawCountry10Id(Object ibmRepDrawCountry10Id) {
		if (ibmRepDrawCountry10Id != null) {
			this.ibmRepDrawCountry10Id = ibmRepDrawCountry10Id.toString();
		}
	}
	public String getIbmRepDrawCountry10Id() {
		return this.ibmRepDrawCountry10Id ;
	}

	/**
	 * 抓取数据_国家赛车主键
	 */
	@Column(name="REP_GRAB_COUNTRY_10_ID_")
	private String repGrabCountry10Id;
	public void setRepGrabCountry10Id(String repGrabCountry10Id) {
		this.repGrabCountry10Id=repGrabCountry10Id;
	}
	public void setRepGrabCountry10Id(Object repGrabCountry10Id) {
		if (repGrabCountry10Id != null) {
			this.repGrabCountry10Id = repGrabCountry10Id.toString();
		}
	}
	public String getRepGrabCountry10Id() {
		return this.repGrabCountry10Id ;
	}
