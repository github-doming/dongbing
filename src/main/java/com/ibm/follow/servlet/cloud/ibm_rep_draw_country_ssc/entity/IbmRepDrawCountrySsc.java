package com.ibm.follow.servlet.cloud.ibm_rep_draw_country_ssc.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_country_ssc 
 * IBM_结果数据_国家时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_country_ssc")
public class IbmRepDrawCountrySsc implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_COUNTRY_SSC_ID_")
	private String ibmRepDrawCountrySscId;
	public void setIbmRepDrawCountrySscId(String ibmRepDrawCountrySscId) {
		this.ibmRepDrawCountrySscId=ibmRepDrawCountrySscId;
	}
	public void setIbmRepDrawCountrySscId(Object ibmRepDrawCountrySscId) {
		if (ibmRepDrawCountrySscId != null) {
			this.ibmRepDrawCountrySscId = ibmRepDrawCountrySscId.toString();
		}
	}
	public String getIbmRepDrawCountrySscId() {
		return this.ibmRepDrawCountrySscId ;
	}

	/**
	 * 抓取数据_国家时时彩主键
	 */
	@Column(name="REP_GRAB_COUNTRY_SSC_ID_")
	private String repGrabCountrySscId;
	public void setRepGrabCountrySscId(String repGrabCountrySscId) {
		this.repGrabCountrySscId=repGrabCountrySscId;
	}
	public void setRepGrabCountrySscId(Object repGrabCountrySscId) {
		if (repGrabCountrySscId != null) {
			this.repGrabCountrySscId = repGrabCountrySscId.toString();
		}
	}
	public String getRepGrabCountrySscId() {
		return this.repGrabCountrySscId ;
	}
