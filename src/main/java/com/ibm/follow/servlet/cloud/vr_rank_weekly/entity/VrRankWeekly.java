package com.ibm.follow.servlet.cloud.vr_rank_weekly.entity;
...
/**
 * The persistent class for the database table vr_rank_weekly 
 * VR_每周榜单 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vr_rank_weekly")
public class VrRankWeekly implements Serializable {
	...
	@Column(name="VR_RANK_WEEKLY_ID_")
	private String vrRankWeeklyId;
	public void setVrRankWeeklyId(String vrRankWeeklyId) {
		this.vrRankWeeklyId=vrRankWeeklyId;
	}
	public void setVrRankWeeklyId(Object vrRankWeeklyId) {
		if (vrRankWeeklyId != null) {
			this.vrRankWeeklyId = vrRankWeeklyId.toString();
		}
	}
	public String getVrRankWeeklyId() {
		return this.vrRankWeeklyId ;
	}
