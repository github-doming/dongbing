package com.ibm.follow.servlet.cloud.ibm_handicap_game.entity;
 ...
 * @author Robot
 */
@AnnotationEntity @AnnotationTable(name = "ibm_handicap_game") public class IbmHandicapGame implements Serializable {
	 ...
	 * 根据底层数据库
	 */
	@Id @GeneratedValue(strategy = GenerationType.AUTO) @Column(name = "IBM_HANDICAP_GAME_ID_") private String ibmHandicapGameId;
	 ...
	 * 盘口名称
	 */
	@Column(name = "HANDICAP_NAME_") private String handicapName;
	 ...
	 * 封盘时间
	 */
	@Column(name = "CLOSE_TIME_") private Integer closeTime;
	 ...
	 * 投注执行表名
	 */
	@Column(name = "SUB_IHBI_TABLE_NAME_") private String subIhbiTableName;
	public void setSubIhbiTableName(String subIhbiTableName) {
		this.subIhbiTableName = subIhbiTableName;
	}
	public void setSubIhbiTableName(Object subIhbiTableName) {
		if (subIhbiTableName != null) {
			this.subIhbiTableName = subIhbiTableName.toString();
		}
	}
	public String getSubIhbiTableName() {
		return this.subIhbiTableName;
	}
