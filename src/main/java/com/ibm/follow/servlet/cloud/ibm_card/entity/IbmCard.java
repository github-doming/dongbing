package com.ibm.follow.servlet.cloud.ibm_card.entity;
...
/**
 * The persistent class for the database table ibm_card 
 * IBM_充值卡 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_card")
public class IbmCard implements Serializable {
	...
	@Column(name="IBM_CARD_ID_")
	private String ibmCardId;
	public void setIbmCardId(String ibmCardId) {
		this.ibmCardId=ibmCardId;
	}
	public void setIbmCardId(Object ibmCardId) {
		if (ibmCardId != null) {
			this.ibmCardId = ibmCardId.toString();
		}
	}
	public String getIbmCardId() {
		return this.ibmCardId ;
	}
