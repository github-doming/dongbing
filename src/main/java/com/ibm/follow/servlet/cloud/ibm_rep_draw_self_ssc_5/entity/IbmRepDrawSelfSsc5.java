package com.ibm.follow.servlet.cloud.ibm_rep_draw_self_ssc_5.entity;
...
/**
 * The persistent class for the database table ibm_rep_draw_self_ssc_5 
 * IBM_结果数据_自有时时彩5分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_rep_draw_self_ssc_5")
public class IbmRepDrawSelfSsc5 implements Serializable {
	...
	@Column(name="IBM_REP_DRAW_SELF_SSC_5_ID_")
	private String ibmRepDrawSelfSsc5Id;
	public void setIbmRepDrawSelfSsc5Id(String ibmRepDrawSelfSsc5Id) {
		this.ibmRepDrawSelfSsc5Id=ibmRepDrawSelfSsc5Id;
	}
	public void setIbmRepDrawSelfSsc5Id(Object ibmRepDrawSelfSsc5Id) {
		if (ibmRepDrawSelfSsc5Id != null) {
			this.ibmRepDrawSelfSsc5Id = ibmRepDrawSelfSsc5Id.toString();
		}
	}
	public String getIbmRepDrawSelfSsc5Id() {
		return this.ibmRepDrawSelfSsc5Id ;
	}

	/**
	 * 抓取数据_自有时时彩5分彩主键
	 */
	@Column(name="REP_GRAB_SELF_SSC_5_ID_")
	private String repGrabSelfSsc5Id;
	public void setRepGrabSelfSsc5Id(String repGrabSelfSsc5Id) {
		this.repGrabSelfSsc5Id=repGrabSelfSsc5Id;
	}
	public void setRepGrabSelfSsc5Id(Object repGrabSelfSsc5Id) {
		if (repGrabSelfSsc5Id != null) {
			this.repGrabSelfSsc5Id = repGrabSelfSsc5Id.toString();
		}
	}
	public String getRepGrabSelfSsc5Id() {
		return this.repGrabSelfSsc5Id ;
	}
