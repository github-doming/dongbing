package com.ibm.follow.servlet.vrc.vrc_fm_game_set.entity;
...
/**
 * The persistent class for the database table vrc_fm_game_set 
 * VRC_跟投会员游戏设置 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vrc_fm_game_set")
public class VrcFmGameSet implements Serializable {
	...
	@Column(name="VRC_FM_GAME_SET_ID_")
	private String vrcFmGameSetId;
	public void setVrcFmGameSetId(String vrcFmGameSetId) {
		this.vrcFmGameSetId=vrcFmGameSetId;
	}
	public void setVrcFmGameSetId(Object vrcFmGameSetId) {
		if (vrcFmGameSetId != null) {
			this.vrcFmGameSetId = vrcFmGameSetId.toString();
		}
	}
	public String getVrcFmGameSetId() {
		return this.vrcFmGameSetId ;
	}
