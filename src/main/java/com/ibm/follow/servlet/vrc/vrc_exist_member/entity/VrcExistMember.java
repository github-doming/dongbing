package com.ibm.follow.servlet.vrc.vrc_exist_member.entity;
...
/**
 * The persistent class for the database table vrc_exist_member 
 * VRC客户端_已存在虚拟会员 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vrc_exist_member")
public class VrcExistMember implements Serializable {
	...
	@Column(name="VRC_EXIST_MEMBER_ID_")
	private String vrcExistMemberId;
	public void setVrcExistMemberId(String vrcExistMemberId) {
		this.vrcExistMemberId=vrcExistMemberId;
	}
	public void setVrcExistMemberId(Object vrcExistMemberId) {
		if (vrcExistMemberId != null) {
			this.vrcExistMemberId = vrcExistMemberId.toString();
		}
	}
	public String getVrcExistMemberId() {
		return this.vrcExistMemberId ;
	}
