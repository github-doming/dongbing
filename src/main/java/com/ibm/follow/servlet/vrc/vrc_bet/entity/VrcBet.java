package com.ibm.follow.servlet.vrc.vrc_bet.entity;
...
/**
 * The persistent class for the database table vrc_bet 
 * VRC客户端_投注 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "vrc_bet")
public class VrcBet implements Serializable {
	...
	@Column(name="VRC_BET_ID_")
	private String vrcBetId;
	public void setVrcBetId(String vrcBetId) {
		this.vrcBetId=vrcBetId;
	}
	public void setVrcBetId(Object vrcBetId) {
		if (vrcBetId != null) {
			this.vrcBetId = vrcBetId.toString();
		}
	}
	public String getVrcBetId() {
		return this.vrcBetId ;
	}
