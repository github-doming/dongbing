...
public enum IbmHcCodeEnum {
     ...
     * 403ChangePassword
     */
    IBM_403_PASSWORD_EXPIRED("403PasswordExpired", "Need to change the password") {
        @Override public String getMsgCn() {
	 ...
	 * 403HandicapUpdate
	 */
	IBM_403_HANDICAP_UPDATE("403HandicapUpdate", "Handicap update") {
		@Override public String getMsgCn() {
			return "盘口维护中" ;
		}
	},
	...
	/**
	 * 403PageNavigateNotFind
	 */
	IBM_403_PAGE_NAVIGATE("403PageNavigateNotFind", "Navigation page not found") {
		@Override public String getMsgCn() {
	 ...
	 * 404Crawler
	 */
	IBM_404_CRAWLER("404Crawler", "Crawler information is empty") {
		@Override public String getMsgCn() {
			return "爬虫信息为空";
		}
	},
     ...
     * 404DataNotFind
     */
    IBM_404_INDEX_INFO("404IndexPageNotFind", "index page not found") {
        @Override public String getMsgCn() {
            return "盘口主页面没有找到" ;
        }
    },
	 ...
	 * 404DataNotFind
	 */
	IBM_404_RULE_ERROR("404RuleError", "Game bet rule error") {
		@Override public String getMsgCn() {
			return "下注規則有誤" ;
		}
	},
