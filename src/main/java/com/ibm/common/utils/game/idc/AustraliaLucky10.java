 ...
 * @Version: v1.0
 */
public class AustraliaLucky10 implements PeriodOperation<Integer> {
	...
	private static final AustraliaLucky10 AUSTRALIA_LUCKY_10 = new AustraliaLucky10();
	private AustraliaLucky10() {
	}
	public static AustraliaLucky10 australiaLucky10() {
		return AUSTRALIA_LUCKY_10;
	}
	//endregion
