 ...
 * @Version: v1.0
 */
public class Gxklsf implements PeriodOperation<String> {
	...
	private static final Gxklsf GXKLSF = new Gxklsf();
	private Gxklsf() {
	}
	public static Gxklsf gxklsf() {
		return GXKLSF;
	}
	//endregion
	...
	public long getDrawTime(Object period) {
		...
		int index = NumberTool.getInteger(period.toString().split("-")[0].substring(4));
