 ...
 * @Version: v1.0
 */
public class Eps2 implements PeriodOperation<String> {
	...
	private static final Eps2 EPS2 = new Eps2();
	private Eps2() {
	}
	public static Eps2 eps2() {
		return EPS2;
	}
	//endregion
	...
	@Override public long getDrawTime(Object period) throws ParseException {
		Date day = DateTool.getDay(period.toString().substring(0, 8));
