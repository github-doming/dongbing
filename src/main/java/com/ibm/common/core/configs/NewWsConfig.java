...
public interface NewWsConfig {
	 ...
	 */
	Map<String, String> GAME_CODE = ImmutableMap.<String, String>builder().put(GameUtil.Code.GDKLC.name(), "1_1")
			.put(GameUtil.Code.CQSSC.name(), "1_2").put(GameUtil.Code.PK10.name(), "1_3")
			.put(GameUtil.Code.SELF_10_5.name(), "1_7").build();
