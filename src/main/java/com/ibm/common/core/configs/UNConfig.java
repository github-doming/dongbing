...
public interface UNConfig {
    ...
    Map<String, String> GAME_CODE_ID = ImmutableMap.<String, String>builder().put("GDKLC", "G_1").put("CQSSC", "G_2")
            .put("PK10", "G_3").put("XYFT", "G_24").put("JS10", "G_30").put("JSSSC", "G_29")
            .put("COUNTRY_SSC","G_35").put("COUNTRY_10","G_37").build();

    Map<String, String> GAME_CODE_ID_BetSummary = ImmutableMap.<String, String>builder().put("GDKLC", "KLC").put("CQSSC", "SSC")
            .put("PK10", "BJC").put("XYFT", "G_24").put("JS10", "G_30").put("JSSSC", "G_29")
            .put("COUNTRY_SSC","G_35").put("COUNTRY_10","G_37").build();
