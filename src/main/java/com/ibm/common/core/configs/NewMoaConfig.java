 ...
 * @Version: v1.0
 */
public interface NewMoaConfig {

	/**
	 * 最终球号的  int gamecode + code的值
	 */
	Map<String, String> GAME_CODE = ImmutableMap.<String, String>builder().put(GameUtil.Code.GDKLC.name(), "G")
			.put(GameUtil.Code.CQSSC.name(), "C").put(GameUtil.Code.PK10.name(), "B").put(GameUtil.Code.XYFT.name(), "FT168")
			.put(GameUtil.Code.JSSSC.name(), "SSC168").put(GameUtil.Code.JS10.name(), "SC168")
			.put(GameUtil.Code.COUNTRY_10.name(), "AOZX168").put(GameUtil.Code.COUNTRY_SSC.name(), "AOZ168")
			.build();
