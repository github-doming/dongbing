package com.ibm.old.v1.cloud.ibm_handicap_user.t.entity;
...
/**
 * The persistent class for the database table ibm_handicap_user 
 * IBM_盘口用户的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_handicap_user")
public class IbmHandicapUserT implements Serializable {
	...
	@Column(name="IBM_HANDICAP_USER_ID_")
	...
	public void setIbmHandicapUserId(Object ibmHandicapUserId) {
		if (ibmHandicapUserId != null) {
			this.ibmHandicapUserId = ibmHandicapUserId.toString();
		}else{
			this.ibmHandicapUserId = null;
		}
	}
