package com.ibm.old.v1.cloud.ibm_sys_client_ip.t.vo;

import java.io.Serializable;
/**
 * The vo class for the database table ibm_sys_client_ip 
 * vo类
 * @author Robot
 */

public class IbmSysClientIpTVo implements Serializable {
