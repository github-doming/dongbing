package com.ibm.old.v1.cloud.ibm_profit_plan_vr.t.vo;

import java.io.Serializable;
/**
 * The vo class for the database table ibm_profit_plan_vr 
 * vo类
 * @author Robot
 */

public class IbmProfitPlanVrTVo implements Serializable {
