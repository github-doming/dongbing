package com.ibm.old.v1.cloud.ibm_available_time.t.entity;
...
/**
 * The persistent class for the database table ibm_available_time 
 * IBM_用户可用时长的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_available_time")
public class IbmAvailableTimeT implements Serializable {
	...
	@Column(name="IBM_AVAILABLE_TIME_ID_")
	...
	public void setIbmAvailableTimeId(Object ibmAvailableTimeId) {
		if (ibmAvailableTimeId != null) {
			this.ibmAvailableTimeId = ibmAvailableTimeId.toString();
		}
	}
	 ...
	 * 末次报表主键
	 */
	@Column(name="REP_AVAILABLE_TIME_ID_")
	...
	public void setRepAvailableTimeId(Object repAvailableTimeId) {
		if (repAvailableTimeId != null) {
			this.repAvailableTimeId = repAvailableTimeId.toString();
		}
	}
