package com.ibm.old.v1.cloud.ibm_profit.t.entity;
...
/**
 * The persistent class for the database table ibm_profit 
 * IBM_盘口会员总盈亏的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_profit")
public class IbmProfitT implements Serializable {
	...
	@Column(name="IBM_PROFIT_ID_")
	private String ibmProfitId;
	public void setIbmProfitId(String ibmProfitId) {
		this.ibmProfitId=ibmProfitId;
	}
	public void setIbmProfitId(Object ibmProfitId) {
		if (ibmProfitId != null) {
			this.ibmProfitId = ibmProfitId.toString();
		}
	}
