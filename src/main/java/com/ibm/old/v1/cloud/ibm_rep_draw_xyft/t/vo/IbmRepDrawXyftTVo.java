package com.ibm.old.v1.cloud.ibm_rep_draw_xyft.t.vo;

import java.io.Serializable;
/**
 * The vo class for the database table ibm_rep_draw_xyft 
 * vo类
 * @author Robot
 */

public class IbmRepDrawXyftTVo implements Serializable {
