package com.ibm.old.v1.cloud.ibm_profit_info_vr.t.entity;
...
/**
 * The persistent class for the database table ibm_profit_info_vr 
 * IBM_盘口会员模拟盈亏信息的实体类
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_profit_info_vr")
public class IbmProfitInfoVrT implements Serializable {
...
@Column(name="IBM_PROFIT_INFO_VR_ID_")
	private String ibmProfitInfoVrId;
	
	public void setIbmProfitInfoVrId(String ibmProfitInfoVrId) {
		this.ibmProfitInfoVrId=ibmProfitInfoVrId;
	}
	public String getIbmProfitInfoVrId() {
		return this.ibmProfitInfoVrId ;
	}
			
			
//盘口会员方案模拟盈亏主键
@Column(name="PROFIT_PLAN_VR_ID_")
	private String profitPlanVrId;
	
	public void setProfitPlanVrId(String profitPlanVrId) {
		this.profitPlanVrId=profitPlanVrId;
	}
	public String getProfitPlanVrId() {
		return this.profitPlanVrId ;
	}
