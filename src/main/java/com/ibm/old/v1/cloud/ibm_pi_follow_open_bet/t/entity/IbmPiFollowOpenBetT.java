package com.ibm.old.v1.cloud.ibm_pi_follow_open_bet.t.entity;
...
/**
 * The persistent class for the database table ibm_pi_follow_open_bet 
 * IBM_开某投某的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_pi_follow_open_bet")
public class IbmPiFollowOpenBetT implements Serializable {

	private static final long serialVersionUID = 1L;

	/**
	 * IBM_开某投某主键IBM_PI_FOLLOW_OPEN_BET_ID_
	 * 根据底层数据库
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="IBM_PI_FOLLOW_OPEN_BET_ID_")
	private String ibmPiFollowOpenBetId;
	public void setIbmPiFollowOpenBetId(String ibmPiFollowOpenBetId) {
		this.ibmPiFollowOpenBetId=ibmPiFollowOpenBetId;
	}
	public void setIbmPiFollowOpenBetId(Object ibmPiFollowOpenBetId) {
		if (ibmPiFollowOpenBetId != null) {
			this.ibmPiFollowOpenBetId = ibmPiFollowOpenBetId.toString();
		}else{
			this.ibmPiFollowOpenBetId = null;
		}
	}
	public String getIbmPiFollowOpenBetId() {
		return this.ibmPiFollowOpenBetId ;
	}
	...
	/**
	 * 下注内容相同时才翻倍DOUBLE_TO_BET_SAME_
	 */
	@Column(name="DOUBLE_TO_BET_SAME_")
	private String doubleToBetSame;
	public void setDoubleToBetSame(String doubleToBetSame) {
		this.doubleToBetSame=doubleToBetSame;
	}
	public void setDoubleToBetSame(Object doubleToBetSame) {
		if (doubleToBetSame != null) {
			this.doubleToBetSame = doubleToBetSame.toString();
		}else{
			this.doubleToBetSame = null;
		}
	}
	public String getDoubleToBetSame() {
		return this.doubleToBetSame ;
	}
