package com.ibm.old.v1.cloud.ibm_rep_grab_cqssc.t.service;
 ...
 * @author Robot
 */
public class IbmRepGrabCqsscTService extends BaseService {



	/**
	 * 保存{ay_table_class}对象数据
	 * @param entity IbmRepGrabCqsscT对象数据
	 */
	public String save(IbmRepGrabCqsscT entity) throws Exception {
	...
	/**
	 * 更新IbmRepGrabCqsscT实体信息
	 * @param entity IbmRepGrabCqsscT实体
	 */
	public void update(IbmRepGrabCqsscT entity) throws Exception {
		dao.update(entity);
	}

	/**
	 * 根据ibm_rep_grab_cqssc表主键查找IbmRepGrabCqsscT实体
	 * @param id ibm_rep_grab_cqssc 主键
	 * @return IbmRepGrabCqsscT实体
	 */
	public IbmRepGrabCqsscT find(String id) throws Exception {
		return (IbmRepGrabCqsscT) this.dao.find(IbmRepGrabCqsscT. class,id);
	...
	/**
	 * 获取分页IbmRepGrabCqsscT数据
	 * @param sortFieldName 排序字段名
	 * @param sortOrderName 排序顺序
	 * @param pageIndex 页面索引
	 * @param pageSize 页面大小
	 * @return 分页IbmRepGrabCqsscT数据
	 */
	public PageCoreBean findObject(String sortFieldName, String sortOrderName, Integer pageIndex,
		...
		return dao.page(IbmRepGrabCqsscT. class,sql, null, pageIndex, pageSize, sqlCount);
	}
	...
	/**
	 * 按照更新顺序查询所有可用IbmRepGrabCqsscT数据信息
	 * @return 可用<IbmRepGrabCqsscT>数据信息
	 */
	public List findObjectAll() throws Exception {
		String sql = "SELECT * FROM ibm_rep_grab_cqssc  where state_!='DEL' order by UPDATE_TIME_ desc";
		return this.dao.findObjectList(IbmRepGrabCqsscT. class,sql);
	}
	...
	public boolean isExist(String period) throws SQLException {
		String sql = "SELECT DRAW_TIME_ FROM ibm_rep_grab_cqssc  where PERIOD_ = ? and state_ = ?";
		List<Object> parameters = new ArrayList<>();
	...
	public String findDrawNumber(String period) throws SQLException {
		String sql = "SELECT DRAW_NUMBER_ FROM `ibm_rep_grab_cqssc` where PERIOD_ = ? and state_!='DEL'";
		List<Object> parameters = new ArrayList<>();
		parameters.add(period);
