package com.ibm.old.v1.cloud.ibm_profit_plan_vr.t.entity;
...
/**
 * The persistent class for the database table ibm_profit_plan_vr 
 * IBM_盘口会员方案模拟盈亏的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_profit_plan_vr")
public class IbmProfitPlanVrT implements Serializable {
	...
	@Column(name="IBM_PROFIT_PLAN_VR_ID_")
	private String ibmProfitPlanVrId;
	public void setIbmProfitPlanVrId(String ibmProfitPlanVrId) {
		this.ibmProfitPlanVrId=ibmProfitPlanVrId;
	}
	public void setIbmProfitPlanVrId(Object ibmProfitPlanVrId) {
		if (ibmProfitPlanVrId != null) {
			this.ibmProfitPlanVrId = ibmProfitPlanVrId.toString();
		}
	}
	public String getIbmProfitPlanVrId() {
		return this.ibmProfitPlanVrId ;
	}

	/**
	 * 盘口会员模拟盈亏主键
	 */
	@Column(name="PROFIT_VR_ID_")
	private String profitVrId;
	public void setProfitVrId(String profitVrId) {
		this.profitVrId=profitVrId;
	}
	public void setProfitVrId(Object profitVrId) {
		if (profitVrId != null) {
			this.profitVrId = profitVrId.toString();
		}
	}
	public String getProfitVrId() {
		return this.profitVrId ;
	}
