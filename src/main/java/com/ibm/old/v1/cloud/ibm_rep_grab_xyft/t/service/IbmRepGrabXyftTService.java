package com.ibm.old.v1.cloud.ibm_rep_grab_xyft.t.service;
 ...
 * @author Robot
 */
public class IbmRepGrabXyftTService extends BaseService {

	/**
	 * 保存{ay_table_class}对象数据
	 *
	 * @param entity IbmRepGrabXyftT对象数据
	 */
	public String save(IbmRepGrabXyftT entity) throws Exception {
	...
	/**
	 * 更新IbmRepGrabXyftT实体信息
	 *
	 * @param entity IbmRepGrabXyftT实体
	 */
	public void update(IbmRepGrabXyftT entity) throws Exception {
		dao.update(entity);
	}

	/**
	 * 根据ibm_rep_grab_xyft表主键查找IbmRepGrabXyftT实体
	 *
	 * @param id ibm_rep_grab_xyft 主键
	 * @return IbmRepGrabXyftT实体
	 */
	public IbmRepGrabXyftT find(String id) throws Exception {
		return (IbmRepGrabXyftT) this.dao.find(IbmRepGrabXyftT.class, id);
	...
	/**
	 * 获取分页IbmRepGrabXyftT数据
	 *
	 * @param sortFieldName 排序字段名
	 * @param sortOrderName 排序顺序
	 * @param pageIndex     页面索引
	 * @param pageSize      页面大小
	 * @return 分页IbmRepGrabXyftT数据
	 */
	public PageCoreBean findObject(String sortFieldName, String sortOrderName, Integer pageIndex, Integer pageSize)
		...
		return dao.page(IbmRepGrabXyftT.class, sql, null, pageIndex, pageSize, sqlCount);
	}
	...
	/**
	 * 按照更新顺序查询所有可用IbmRepGrabXyftT数据信息
	 *
	 * @return 可用<IbmRepGrabXyftT>数据信息
	 */
	public List findObjectAll() throws Exception {
		String sql = "SELECT * FROM ibm_rep_grab_xyft  where state_!='DEL' order by UPDATE_TIME_ desc";
		return this.dao.findObjectList(IbmRepGrabXyftT.class, sql);
	}
	...
	public boolean isExist(String period) throws SQLException {
		String sql = "SELECT DRAW_TIME_ FROM ibm_rep_grab_xyft  where PERIOD_ = ? and state_ = ?";
		List<Object> parameters = new ArrayList<>();
	...
	public String findDrawNumber(String period) throws SQLException {
		String sql = "SELECT DRAW_NUMBER_ FROM `ibm_rep_grab_xyft` where PERIOD_ = ? and state_!='DEL'";
		List<Object> parameters = new ArrayList<>();
		parameters.add(period);
