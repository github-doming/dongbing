package com.ibm.old.v1.cloud.ibm_pi_number_to_track.t.entity;
...
/**
 * The persistent class for the database table ibm_pi_number_to_track 
 * IBM_号码追踪IBM_PI_NUMBER_TO_TRACK的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_pi_number_to_track")
public class IbmPiNumberToTrackT implements Serializable {

	private static final long serialVersionUID = 1L;

	/**
	 * IBM_号码追踪主键IBM_PI_NUMBER_TO_TRACK_ID_
	 * 根据底层数据库
	 */
	@Id
	@GeneratedValue(strategy = GenerationType.AUTO)
	@Column(name="IBM_PI_NUMBER_TO_TRACK_ID_")
	private String ibmPiNumberToTrackId;
	public void setIbmPiNumberToTrackId(String ibmPiNumberToTrackId) {
		this.ibmPiNumberToTrackId=ibmPiNumberToTrackId;
	}
	public void setIbmPiNumberToTrackId(Object ibmPiNumberToTrackId) {
		if (ibmPiNumberToTrackId != null) {
			this.ibmPiNumberToTrackId = ibmPiNumberToTrackId.toString();
		}else{
			this.ibmPiNumberToTrackId = null;
		}
	}
	public String getIbmPiNumberToTrackId() {
		return this.ibmPiNumberToTrackId ;
	}
