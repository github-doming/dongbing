package com.ibm.old.v1.cloud.ibm_cloud_config.t.entity;
...
/**
 * The persistent class for the database table ibm_cloud_config 
 * IBM_中心端配置的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_cloud_config")
public class IbmCloudConfigT implements Serializable {
	...
	@Column(name="IBM_CLOUD_CONFIG_ID_")
	...
	public void setIbmCloudConfigId(Object ibmCloudConfigId) {
		if (ibmCloudConfigId != null) {
			this.ibmCloudConfigId = ibmCloudConfigId.toString();
		}
	}
	 ...
	 * 中心端配置KEY
	 */
	@Column(name="CLOUD_CONFIG_KEY_")
	private String cloudConfigKey;
	public void setCloudConfigKey(String cloudConfigKey) {
		this.cloudConfigKey=cloudConfigKey;
	}
	public void setCloudConfigKey(Object cloudConfigKey) {
		if (cloudConfigKey != null) {
			this.cloudConfigKey = cloudConfigKey.toString();
		}
	}
	 ...
	 * 中心端配置VALUE
	 */
	@Column(name="CLOUD_CONFIG_VALUE_")
	...
	public void setCloudConfigValue(Object cloudConfigValue) {
		if (cloudConfigValue != null) {
			this.cloudConfigValue = cloudConfigValue.toString();
		}
	}
