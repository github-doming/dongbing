package com.ibm.old.v1.cloud.ibm_point.t.entity;
...
/**
 * The persistent class for the database table ibm_point 
 * IBM_点数的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibm_point")
public class IbmPointT implements Serializable {
	...
	@Column(name="IBM_POINT_ID_")
	private String ibmPointId;
	public void setIbmPointId(String ibmPointId) {
		this.ibmPointId=ibmPointId;
	}
	public void setIbmPointId(Object ibmPointId) {
		if (ibmPointId != null) {
			this.ibmPointId = ibmPointId.toString();
		}
	}
