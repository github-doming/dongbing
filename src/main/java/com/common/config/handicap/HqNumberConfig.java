 ...
 * @Version: v1.0
 */
public interface HqNumberConfig extends HqConfig,NumberConfig {
	/**
	 * 投注类型map
	 */
	Map<String, String> BET_TYPE = ImmutableMap.<String, String>builder()
			.put("dobleSides", "1").put("ballNO", "2").put("sumDT", "5").build();

	/**
	 * 游戏code
	 */

	Map<String, String> ITEM_CODE = ImmutableMap.<String, String>builder().put("第一名|1", "01101").put("第一名|2", "01102")
	...
	Map<String, String> CODE_ITEM = ImmutableMap.<String, String>builder().put("01101", "第一名|1")
	 ...
	 * 投注限制
	 */
	Map<String, String> ITEM_LIMIT = ImmutableMap.<String, String>builder().put("第一名|1", "03").put("第一名|2", "03")
	...
	Map<String, String> RESULT_ITEM = ImmutableMap.<String, String>builder().put("冠军1", "第一名|1").put("冠军2", "第一名|2")
