...
public interface IdcBallConfig extends IdcConfig,BallConfig {
	...
	Map<String, String> ITEM_CODE = ImmutableMap.<String, String>builder().put("第一球|0", "205:0").put("第一球|1", "205:1")
	...
	Map<String, String> CODE_ITEM = ImmutableMap.<String, String>builder().put("205:0", "第一球|0").put("205:1", "第一球|1")
