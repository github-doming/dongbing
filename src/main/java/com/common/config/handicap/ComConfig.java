 ...
 *
 * @Author: Dongming
 * @Date: 2020-06-10 10:55
 * @Email: job.dongming@foxmail.com
 * @Version: v1.0
 */
public interface ComConfig {

	Map<String, String> GAME_TYPE = ImmutableMap.<String, String>builder().put("PK10", "2").put("XYFT", "9")
			.put("JS10", "10").put("CQSSC", "1").put("JSSSC", "11").put("GDKLC", "0").build();



	Map<String, String> GAME_CODE = ImmutableMap.<String, String>builder().put("GDKLC", "kl10").put("PK10", "pk10").put("XYFT", "xyft5")
			.put("JS10", "jscar").put("CQSSC", "cqsc").put("JSSSC", "speed5").build();

	Map<String, String> GAME_URL = ImmutableMap.<String, String>builder().put("GDKLC", "L_KL10").put("CQSSC", "L_CQSC").put("PK10", "L_PK10")
