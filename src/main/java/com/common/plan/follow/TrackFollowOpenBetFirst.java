...
/**
 * @Description: 号码追踪开某投某方式一
 * @Author: null
 * @Date: 2020-09-10 11:05
 */
public class TrackFollowOpenBetFirst extends PlanBase {

	public static TrackFollowOpenBetFirst getInstance() {
		return new TrackFollowOpenBetFirst();
	}
