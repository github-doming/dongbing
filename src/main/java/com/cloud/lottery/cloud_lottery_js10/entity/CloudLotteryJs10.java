package com.cloud.lottery.cloud_lottery_js10.entity;
...
/**
 * The persistent class for the database table cloud_lottery_js10 
 * 云服务_开奖_急速赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_js10")
public class CloudLotteryJs10 implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_JS10_ID_")
	private String cloudLotteryJs10Id;
	public void setCloudLotteryJs10Id(String cloudLotteryJs10Id) {
		this.cloudLotteryJs10Id=cloudLotteryJs10Id;
	}
	public void setCloudLotteryJs10Id(Object cloudLotteryJs10Id) {
		if (cloudLotteryJs10Id != null) {
			this.cloudLotteryJs10Id = cloudLotteryJs10Id.toString();
		}
	}
	public String getCloudLotteryJs10Id() {
		return this.cloudLotteryJs10Id ;
	}
	...
	@Override public String toString() {
		return "CloudLotteryJs10{" + "handicapCode='" + handicapCode + '\'' + ", period='" + period + '\''
				+ ", p1Number='" + p1Number + '\'' + ", p2Number='" + p2Number + '\'' + ", p3Number='" + p3Number + '\''
				+ ", p4Number='" + p4Number + '\'' + ", p5Number='" + p5Number + '\'' + ", p6Number='" + p6Number + '\''
				+ ", p7Number='" + p7Number + '\'' + ", p8Number='" + p8Number + '\'' + ", p9Number='" + p9Number + '\''
				+ ", p10Number='" + p10Number + '\'' + '}';
	}
}