package com.cloud.lottery.cloud_lottery_country_10.entity;
...
/**
 * The persistent class for the database table cloud_lottery_country_10 
 * 云服务_开奖_国家赛车 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_country_10")
public class CloudLotteryCountry10 implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_COUNTRY_10_ID_")
	private String cloudLotteryCountry10Id;
	public void setCloudLotteryCountry10Id(String cloudLotteryCountry10Id) {
		this.cloudLotteryCountry10Id=cloudLotteryCountry10Id;
	}
	public void setCloudLotteryCountry10Id(Object cloudLotteryCountry10Id) {
		if (cloudLotteryCountry10Id != null) {
			this.cloudLotteryCountry10Id = cloudLotteryCountry10Id.toString();
		}
	}
	public String getCloudLotteryCountry10Id() {
		return this.cloudLotteryCountry10Id ;
	}
