package com.cloud.lottery.cloud_lottery_self_ssc_5.entity;
...
/**
 * The persistent class for the database table cloud_lottery_self_ssc_5 
 * 云服务_开奖_自有时时彩5分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_self_ssc_5")
public class CloudLotterySelfSsc5 implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_SELF_SSC_5_ID_")
	private String cloudLotterySelfSsc5Id;
	public void setCloudLotterySelfSsc5Id(String cloudLotterySelfSsc5Id) {
		this.cloudLotterySelfSsc5Id=cloudLotterySelfSsc5Id;
	}
	public void setCloudLotterySelfSsc5Id(Object cloudLotterySelfSsc5Id) {
		if (cloudLotterySelfSsc5Id != null) {
			this.cloudLotterySelfSsc5Id = cloudLotterySelfSsc5Id.toString();
		}
	}
	public String getCloudLotterySelfSsc5Id() {
		return this.cloudLotterySelfSsc5Id ;
	}
