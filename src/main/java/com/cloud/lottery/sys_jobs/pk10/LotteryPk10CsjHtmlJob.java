...
/**
 * @Description: 抓取彩世界页面的PK10数据
 * @Author: Dongming
 * @Date: 2019-01-19 10:20
 * @Email: job.dongming@foxmail.com
 * @Version: v1.0
 */
public class LotteryPk10CsjHtmlJob extends BaseCommJob {
	...
	private CloudLotteryPk10T getLotteryPk10T(Integer period) throws Exception {
		...
		String url = LotteryTool.getCsjHost().concat("/pk10/");
		...
		//期数匹配不上重新抓取
		if (!text.equals(period.toString())) {
