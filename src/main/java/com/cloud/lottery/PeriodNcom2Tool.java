...
public class PeriodNcom2Tool extends PeriodTool {
    ...
    private static final String JS_DATA_START = "00:01:15";
    private static final long JS_PERIOD = 75 * 1000L;
    public static final long HOUR_TIME = 60*60*1000L; // 一小时时间戳
