package com.cloud.lottery.cloud_lottery_xync.entity;
...
/**
 * The persistent class for the database table cloud_lottery_xync 
 * 云服务_开奖_幸运农场 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_xync")
public class CloudLotteryXync implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_XYNC_ID_")
	private String cloudLotteryXyncId;
	public void setCloudLotteryXyncId(String cloudLotteryXyncId) {
		this.cloudLotteryXyncId=cloudLotteryXyncId;
	}
	public void setCloudLotteryXyncId(Object cloudLotteryXyncId) {
		if (cloudLotteryXyncId != null) {
			this.cloudLotteryXyncId = cloudLotteryXyncId.toString();
		}
	}
	public String getCloudLotteryXyncId() {
		return this.cloudLotteryXyncId ;
	}
