package com.cloud.lottery.cloud_lottery_self_10_2.entity;
...
/**
 * The persistent class for the database table cloud_lottery_self_10_2 
 * 云服务_开奖_自有赛车2分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_self_10_2")
public class CloudLotterySelf102 implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_SELF_10_2_ID_")
	private String cloudLotterySelf102Id;
	public void setCloudLotterySelf102Id(String cloudLotterySelf102Id) {
		this.cloudLotterySelf102Id=cloudLotterySelf102Id;
	}
	public void setCloudLotterySelf102Id(Object cloudLotterySelf102Id) {
		if (cloudLotterySelf102Id != null) {
			this.cloudLotterySelf102Id = cloudLotterySelf102Id.toString();
		}
	}
	public String getCloudLotterySelf102Id() {
		return this.cloudLotterySelf102Id ;
	}
