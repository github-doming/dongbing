package com.cloud.lottery.cloud_lottery_country_ssc.entity;
...
/**
 * The persistent class for the database table cloud_lottery_country_ssc 
 * 云服务_开奖_国家时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_country_ssc")
public class CloudLotteryCountrySsc implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_COUNTRY_SSC_ID_")
	private String cloudLotteryCountrySscId;
	public void setCloudLotteryCountrySscId(String cloudLotteryCountrySscId) {
		this.cloudLotteryCountrySscId=cloudLotteryCountrySscId;
	}
	public void setCloudLotteryCountrySscId(Object cloudLotteryCountrySscId) {
		if (cloudLotteryCountrySscId != null) {
			this.cloudLotteryCountrySscId = cloudLotteryCountrySscId.toString();
		}
	}
	public String getCloudLotteryCountrySscId() {
		return this.cloudLotteryCountrySscId ;
	}
