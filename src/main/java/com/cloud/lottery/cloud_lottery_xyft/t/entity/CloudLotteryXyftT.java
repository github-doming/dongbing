package com.cloud.lottery.cloud_lottery_xyft.t.entity;
...
/**
 * The persistent class for the database table cloud_lottery_xyft 
 * 云服务_开奖_幸运飞艇的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_xyft")
public class CloudLotteryXyftT implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_XYFT_ID_")
	private String cloudLotteryXyftId;
	public void setCloudLotteryXyftId(String cloudLotteryXyftId) {
		this.cloudLotteryXyftId=cloudLotteryXyftId;
	}
	public void setCloudLotteryXyftId(Object cloudLotteryXyftId) {
		if (cloudLotteryXyftId != null) {
			this.cloudLotteryXyftId = cloudLotteryXyftId.toString();
		}
	}
	public String getCloudLotteryXyftId() {
		return this.cloudLotteryXyftId ;
	}
	...
	@Override public String toString() {
		return "CloudLotteryXyftT{" + "period='" + period + '\'' + ", drawTime=" + drawTime + ", p1Number='" + p1Number
				+ '\'' + ", p2Number='" + p2Number + '\'' + ", p3Number='" + p3Number + '\'' + ", p4Number='" + p4Number
				+ '\'' + ", p5Number='" + p5Number + '\'' + ", p6Number='" + p6Number + '\'' + ", p7Number='" + p7Number
				+ '\'' + ", p8Number='" + p8Number + '\'' + ", p9Number='" + p9Number + '\'' + ", p10Number='"
				+ p10Number + '\'' + '}';
	}
}