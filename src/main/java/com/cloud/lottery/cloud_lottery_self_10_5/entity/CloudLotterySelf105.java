package com.cloud.lottery.cloud_lottery_self_10_5.entity;
...
/**
 * The persistent class for the database table cloud_lottery_self_10_5 
 * 云服务_开奖_自有赛车5分彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_self_10_5")
public class CloudLotterySelf105 implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_SELF_10_5_ID_")
	private String cloudLotterySelf105Id;
	public void setCloudLotterySelf105Id(String cloudLotterySelf105Id) {
		this.cloudLotterySelf105Id=cloudLotterySelf105Id;
	}
	public void setCloudLotterySelf105Id(Object cloudLotterySelf105Id) {
		if (cloudLotterySelf105Id != null) {
			this.cloudLotterySelf105Id = cloudLotterySelf105Id.toString();
		}
	}
	public String getCloudLotterySelf105Id() {
		return this.cloudLotterySelf105Id ;
	}
	...
	public void setDrawItem(Object drawItem) {
		if (drawItem != null) {
			this.drawItem = drawItem.toString();
		}
	}
