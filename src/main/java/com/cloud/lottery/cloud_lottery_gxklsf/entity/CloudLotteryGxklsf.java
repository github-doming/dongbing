package com.cloud.lottery.cloud_lottery_gxklsf.entity;
...
/**
 * The persistent class for the database table cloud_lottery_gxklsf 
 * 云服务_开奖_广西快乐十分 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_gxklsf")
public class CloudLotteryGxklsf implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_GXKLSF_ID_")
	private String cloudLotteryGxklsfId;
	public void setCloudLotteryGxklsfId(String cloudLotteryGxklsfId) {
		this.cloudLotteryGxklsfId=cloudLotteryGxklsfId;
	}
	public void setCloudLotteryGxklsfId(Object cloudLotteryGxklsfId) {
		if (cloudLotteryGxklsfId != null) {
			this.cloudLotteryGxklsfId = cloudLotteryGxklsfId.toString();
		}
	}
	public String getCloudLotteryGxklsfId() {
		return this.cloudLotteryGxklsfId ;
	}
