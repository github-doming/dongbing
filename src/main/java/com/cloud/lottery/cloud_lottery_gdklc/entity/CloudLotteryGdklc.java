package com.cloud.lottery.cloud_lottery_gdklc.entity;
...
/**
 * The persistent class for the database table cloud_lottery_gdklc 
 * 云服务_开奖_广东快乐十分 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_gdklc")
public class CloudLotteryGdklc implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_GDKLC_ID_")
	private String cloudLotteryGdklcId;
	public void setCloudLotteryGdklcId(String cloudLotteryGdklcId) {
		this.cloudLotteryGdklcId=cloudLotteryGdklcId;
	}
	public void setCloudLotteryGdklcId(Object cloudLotteryGdklcId) {
		if (cloudLotteryGdklcId != null) {
			this.cloudLotteryGdklcId = cloudLotteryGdklcId.toString();
		}
	}
	public String getCloudLotteryGdklcId() {
		return this.cloudLotteryGdklcId ;
	}
