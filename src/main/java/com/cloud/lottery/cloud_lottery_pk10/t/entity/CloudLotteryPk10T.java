package com.cloud.lottery.cloud_lottery_pk10.t.entity;
...
/**
 * The persistent class for the database table cloud_lottery_pk10 
 * 云服务_开奖_北京赛车的实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_pk10")
public class CloudLotteryPk10T implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_PK10_ID_")
	private String cloudLotteryPk10Id;
	public void setCloudLotteryPk10Id(String cloudLotteryPk10Id) {
		this.cloudLotteryPk10Id=cloudLotteryPk10Id;
	}
	public void setCloudLotteryPk10Id(Object cloudLotteryPk10Id) {
		if (cloudLotteryPk10Id != null) {
			this.cloudLotteryPk10Id = cloudLotteryPk10Id.toString();
		}
	}
	public String getCloudLotteryPk10Id() {
		return this.cloudLotteryPk10Id ;
	}
