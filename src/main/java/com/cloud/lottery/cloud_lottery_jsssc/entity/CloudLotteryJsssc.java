package com.cloud.lottery.cloud_lottery_jsssc.entity;
...
/**
 * The persistent class for the database table cloud_lottery_jsssc 
 * 云服务_开奖_急速时时彩 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "cloud_lottery_jsssc")
public class CloudLotteryJsssc implements Serializable {
	...
	@Column(name="CLOUD_LOTTERY_JSSSC_ID_")
	private String cloudLotteryJssscId;
	public void setCloudLotteryJssscId(String cloudLotteryJssscId) {
		this.cloudLotteryJssscId=cloudLotteryJssscId;
	}
	public void setCloudLotteryJssscId(Object cloudLotteryJssscId) {
		if (cloudLotteryJssscId != null) {
			this.cloudLotteryJssscId = cloudLotteryJssscId.toString();
		}
	}
	public String getCloudLotteryJssscId() {
		return this.cloudLotteryJssscId ;
	}
