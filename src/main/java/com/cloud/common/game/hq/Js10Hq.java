 ...
 * @Version: v1.0
 */
public class Js10Hq extends NumberGame implements PeriodOperation<String> {
	...
	public long getDrawTime(String period) {
		return (Integer.parseInt(period.substring(8)) - 1) * PERIOD + DateTool.getTime(JS_DATA_START).getTime();
	}
