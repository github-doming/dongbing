package com.cloud.user.app_user_point_rep.entity;
...
/**
 * The persistent class for the database table app_user_point_rep 
 * APP用户点数使用情况 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "app_user_point_rep")
public class AppUserPointRep implements Serializable {
	...
	@Column(name="APP_USER_POINT_REP_ID_")
	private String appUserPointRepId;
	public void setAppUserPointRepId(String appUserPointRepId) {
		this.appUserPointRepId=appUserPointRepId;
	}
	public void setAppUserPointRepId(Object appUserPointRepId) {
		if (appUserPointRepId != null) {
			this.appUserPointRepId = appUserPointRepId.toString();
		}
	}
	public String getAppUserPointRepId() {
		return this.appUserPointRepId ;
	}
