package com.cloud.user.app_verify_code.entity;
...
/**
 * The persistent class for the database table app_verify_code 
 * APP认证_验证码 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "app_verify_code")
public class AppVerifyCode implements Serializable {
	...
	@Column(name="APP_VERIFY_CODE_ID_")
	private String appVerifyCodeId;
	public void setAppVerifyCodeId(String appVerifyCodeId) {
		this.appVerifyCodeId=appVerifyCodeId;
	}
	public void setAppVerifyCodeId(Object appVerifyCodeId) {
		if (appVerifyCodeId != null) {
			this.appVerifyCodeId = appVerifyCodeId.toString();
		}
	}
	public String getAppVerifyCodeId() {
		return this.appVerifyCodeId ;
	}
