package com.cloud.user.app_verify_mail.entity;
...
public class AppVerifyMail implements Serializable {
	...
	public void setAppVerifyMailId(Object appVerifyMailId) {
		if (appVerifyMailId != null) {
			this.appVerifyMailId = appVerifyMailId.toString();
		}
	}
