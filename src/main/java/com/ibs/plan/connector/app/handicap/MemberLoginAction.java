 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/app/handicap/login", method = HttpConfig.Method.POST) public class MemberLoginAction
	...
	@Override public Object run() throws Exception {
		...
		try {
			...
			log.error("{}会员登录错误，{}", IbsConfig.LOG_SIGN, e.getMessage());
			throw e;
		}
		return bean;
	}
	...
	private String accountLogin(String handicapId, IbspHandicapMemberService handicapMemberService)
		...
		handicapItemService.updateUseTime(handicapItemId, nowTime);
