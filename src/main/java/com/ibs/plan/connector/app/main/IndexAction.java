 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/app/main/index", method = HttpConfig.Method.POST)
public class IndexAction extends CommCoreAction {
	...
	public Object run() throws Exception {
		...
		try {
			...
			String userId = userTokenService.findUserId(token, ChannelTypeEnum.APP, IbsTypeEnum.USER);
			//校验TOKEN，校验存在
			...
			String tokenId=userTokenService.findId(userId,ChannelTypeEnum.APP, IbsTypeEnum.USER);
