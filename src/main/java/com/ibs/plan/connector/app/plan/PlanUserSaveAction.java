 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/app/plan/save", method = HttpConfig.Method.POST)
public class PlanUserSaveAction extends CommCoreAction {
	...
	public Object run() throws Exception {
		...
		try {
			...
			//添加方案用户信息
			savePlanUser(planGame,planItemInit,planItemId,gameId,sn);
	...
	private void savePlanUser(Map<String, Object> planGame, IbspPlanItem planItemInit, String planItemId,String gameId,String sn) throws Exception {
