 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/sys/manage/authority/user/list")
public class UserListAction extends CommAdminAction {
	...
	public Object run() throws Exception {
		...
		try {
			...
			PageCoreBean<Map<String, Object>> basePage = authorityService.listAllUser(appUserId, userName, pageIndex, pageSize);
