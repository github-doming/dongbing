 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/pc/handicap/eventResult", method = HttpConfig.Method.GET) public class EventResultAction
	...
	@Override public Object run() throws Exception {
		...
		Object loginCode = dataMap.getOrDefault("eventCode", "");
