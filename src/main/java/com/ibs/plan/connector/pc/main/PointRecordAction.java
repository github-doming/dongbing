 ...
 * @Version: v1.0
 */
@ActionMapping(value = "/ibs/pc/home/pointRecord")
public class PointRecordAction extends CommCoreAction {
	...
	public Object run() throws Exception {
		...
		try {
			...
			PageCoreBean<Map<String, Object>> pageDate = new IbspLogManagePointService().pageUserPointRecord(appUserId, pageIndex, pageSize);
			...
			log.error(IbsConfig.LOG_SIGN.concat("查询积分记录错误"), e);
			data.put("rows", null);
			data.put("index", 0);
			data.put("total", 0);
		}
