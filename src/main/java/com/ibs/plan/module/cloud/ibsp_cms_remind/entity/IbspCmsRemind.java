package com.ibs.plan.module.cloud.ibsp_cms_remind.entity;
...
/**
 * The persistent class for the database table ibsp_cms_remind 
 * IBSP消息提醒 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_cms_remind")
public class IbspCmsRemind implements Serializable {
	...
	@Column(name="IBSP_CMS_REMIND_ID_")
	private String ibspCmsRemindId;
	public void setIbspCmsRemindId(String ibspCmsRemindId) {
		this.ibspCmsRemindId=ibspCmsRemindId;
	}
	public void setIbspCmsRemindId(Object ibspCmsRemindId) {
		if (ibspCmsRemindId != null) {
			this.ibspCmsRemindId = ibspCmsRemindId.toString();
		}
	}
	public String getIbspCmsRemindId() {
		return this.ibspCmsRemindId ;
	}
