package com.ibs.plan.module.cloud.ibsp_log_hm.entity;
...
/**
 * The persistent class for the database table ibsp_log_hm 
 * IBSP_盘口会员操作日志 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_log_hm")
public class IbspLogHm implements Serializable {
	...
	@Column(name="IBSP_LOG_HM_ID_")
	private String ibspLogHmId;
	public void setIbspLogHmId(String ibspLogHmId) {
		this.ibspLogHmId=ibspLogHmId;
	}
	public void setIbspLogHmId(Object ibspLogHmId) {
		if (ibspLogHmId != null) {
			this.ibspLogHmId = ibspLogHmId.toString();
		}
	}
	public String getIbspLogHmId() {
		return this.ibspLogHmId ;
	}
