package com.ibs.plan.module.cloud.ibsp_client_handicap_capacity.entity;
...
/**
 * The persistent class for the database table ibsp_client_handicap_capacity 
 * IBSP_客户端盘口容量记录 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_client_handicap_capacity")
public class IbspClientHandicapCapacity implements Serializable {
	...
	@Column(name="IBSP_CLIENT_HANDICAP_CAPACITY_ID_")
	private String ibspClientHandicapCapacityId;
	public void setIbspClientHandicapCapacityId(String ibspClientHandicapCapacityId) {
		this.ibspClientHandicapCapacityId=ibspClientHandicapCapacityId;
	}
	public void setIbspClientHandicapCapacityId(Object ibspClientHandicapCapacityId) {
		if (ibspClientHandicapCapacityId != null) {
			this.ibspClientHandicapCapacityId = ibspClientHandicapCapacityId.toString();
		}
	}
	public String getIbspClientHandicapCapacityId() {
		return this.ibspClientHandicapCapacityId ;
	}

	/**
	 * 中心端客户端容量记录主键
	 */
	@Column(name="CLIENT_CAPACITY_ID_")
	private String clientCapacityId;
	 ...
	 * 盘口最大容量
	 */
	@Column(name="CAPACITY_HANDICAP_MAX_")
	private Integer capacityHandicapMax;
	 ...
	 * 盘口使用容量
	 */
	@Column(name="CAPACITY_HANDICAP_")
	private Integer capacityHandicap;
