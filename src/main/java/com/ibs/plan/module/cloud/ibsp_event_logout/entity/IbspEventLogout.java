package com.ibs.plan.module.cloud.ibsp_event_logout.entity;
...
/**
 * The persistent class for the database table ibsp_event_logout 
 * IBSP_客户登出事件 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_event_logout")
public class IbspEventLogout implements Serializable {
	...
	@Column(name="IBSP_EVENT_LOGOUT_ID_")
	private String ibspEventLogoutId;
	public void setIbspEventLogoutId(String ibspEventLogoutId) {
		this.ibspEventLogoutId=ibspEventLogoutId;
	}
	public void setIbspEventLogoutId(Object ibspEventLogoutId) {
		if (ibspEventLogoutId != null) {
			this.ibspEventLogoutId = ibspEventLogoutId.toString();
		}
	}
	public String getIbspEventLogoutId() {
		return this.ibspEventLogoutId ;
	}
