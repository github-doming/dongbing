package com.ibs.plan.module.cloud.ibsp_profit_period_vr.entity;
...
/**
 * The persistent class for the database table ibsp_profit_period_vr 
 * IBSP_盘口会员当期模拟盈亏 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_profit_period_vr")
public class IbspProfitPeriodVr implements Serializable {
	...
	@Column(name="IBSP_PROFIT_PERIOD_VR_ID_")
	private String ibspProfitPeriodVrId;
	public void setIbspProfitPeriodVrId(String ibspProfitPeriodVrId) {
		this.ibspProfitPeriodVrId=ibspProfitPeriodVrId;
	}
	public void setIbspProfitPeriodVrId(Object ibspProfitPeriodVrId) {
		if (ibspProfitPeriodVrId != null) {
			this.ibspProfitPeriodVrId = ibspProfitPeriodVrId.toString();
		}
	}
	public String getIbspProfitPeriodVrId() {
		return this.ibspProfitPeriodVrId ;
	}
