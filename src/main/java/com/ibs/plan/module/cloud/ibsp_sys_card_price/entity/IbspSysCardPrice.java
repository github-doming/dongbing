package com.ibs.plan.module.cloud.ibsp_sys_card_price.entity;
...
/**
 * The persistent class for the database table ibsp_sys_card_price 
 * IBSP_点卡价格 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_sys_card_price")
public class IbspSysCardPrice implements Serializable {
	...
	@Column(name="IBSP_SYS_CARD_PRICE_ID_")
	private String ibspSysCardPriceId;
	public void setIbspSysCardPriceId(String ibspSysCardPriceId) {
		this.ibspSysCardPriceId=ibspSysCardPriceId;
	}
	public void setIbspSysCardPriceId(Object ibspSysCardPriceId) {
		if (ibspSysCardPriceId != null) {
			this.ibspSysCardPriceId = ibspSysCardPriceId.toString();
		}
	}
	public String getIbspSysCardPriceId() {
		return this.ibspSysCardPriceId ;
	}
