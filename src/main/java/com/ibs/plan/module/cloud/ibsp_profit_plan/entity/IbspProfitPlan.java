package com.ibs.plan.module.cloud.ibsp_profit_plan.entity;
...
/**
 * The persistent class for the database table ibsp_profit_plan 
 * IBSP_盘口会员方案盈亏 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_profit_plan")
public class IbspProfitPlan implements Serializable {
	...
	@Column(name="IBSP_PROFIT_PLAN_ID_")
	private String ibspProfitPlanId;
	public void setIbspProfitPlanId(String ibspProfitPlanId) {
		this.ibspProfitPlanId=ibspProfitPlanId;
	}
	public void setIbspProfitPlanId(Object ibspProfitPlanId) {
		if (ibspProfitPlanId != null) {
			this.ibspProfitPlanId = ibspProfitPlanId.toString();
		}
	}
	public String getIbspProfitPlanId() {
		return this.ibspProfitPlanId ;
	}
