package com.ibs.plan.module.cloud.ibsp_cms_notify.entity;
...
/**
 * The persistent class for the database table ibsp_cms_notify 
 * IBSP消息列表 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_cms_notify")
public class IbspCmsNotify implements Serializable {
	...
	@Column(name="IBSP_CMS_NOTIFY_ID_")
	private String ibspCmsNotifyId;
	public void setIbspCmsNotifyId(String ibspCmsNotifyId) {
		this.ibspCmsNotifyId=ibspCmsNotifyId;
	}
	public void setIbspCmsNotifyId(Object ibspCmsNotifyId) {
		if (ibspCmsNotifyId != null) {
			this.ibspCmsNotifyId = ibspCmsNotifyId.toString();
		}
	}
	public String getIbspCmsNotifyId() {
		return this.ibspCmsNotifyId ;
	}
	...
	public void setNotifyLevel(Object notifyLevel) {
		if (notifyLevel != null) {
			if (notifyLevel instanceof Integer) {
				this.notifyLevel= (Integer) notifyLevel;
			}else if (StringTool.isInteger(notifyLevel.toString())) {
				this.notifyLevel = Integer.parseInt(notifyLevel.toString());
			}
		}
	}
