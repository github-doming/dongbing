package com.ibs.plan.module.cloud.ibsp_log_monitor_servlet.entity;
...
/**
 * The persistent class for the database table ibsp_log_monitor_servlet 
 * IBS_服务器监控日志 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_log_monitor_servlet")
public class IbspLogMonitorServlet implements Serializable {
	...
	@Column(name="IBSP_LOG_MONITOR_SERVLET_ID_")
	private String ibspLogMonitorServletId;
	public void setIbspLogMonitorServletId(String ibspLogMonitorServletId) {
		this.ibspLogMonitorServletId=ibspLogMonitorServletId;
	}
	public void setIbspLogMonitorServletId(Object ibspLogMonitorServletId) {
		if (ibspLogMonitorServletId != null) {
			this.ibspLogMonitorServletId = ibspLogMonitorServletId.toString();
		}
	}
	public String getIbspLogMonitorServletId() {
		return this.ibspLogMonitorServletId ;
	}
