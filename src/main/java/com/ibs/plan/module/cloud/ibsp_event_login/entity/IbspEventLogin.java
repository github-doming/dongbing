package com.ibs.plan.module.cloud.ibsp_event_login.entity;
...
/**
 * The persistent class for the database table ibsp_event_login 
 * IBSP_客户登录事件 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_event_login")
public class IbspEventLogin implements Serializable {
	...
	@Column(name="IBSP_EVENT_LOGIN_ID_")
	private String ibspEventLoginId;
	public void setIbspEventLoginId(String ibspEventLoginId) {
		this.ibspEventLoginId=ibspEventLoginId;
	}
	public void setIbspEventLoginId(Object ibspEventLoginId) {
		if (ibspEventLoginId != null) {
			this.ibspEventLoginId = ibspEventLoginId.toString();
		}
	}
	public String getIbspEventLoginId() {
		return this.ibspEventLoginId ;
	}
