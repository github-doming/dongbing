package com.ibs.plan.module.cloud.ibsp_sys_manage_point.entity;
...
/**
 * The persistent class for the database table ibsp_sys_manage_point 
 * IBSP_用户点数 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_sys_manage_point")
public class IbspSysManagePoint implements Serializable {
	...
	@Column(name="IBSP_SYS_MANAGE_POINT_ID_")
	private String ibspSysManagePointId;
	public void setIbspSysManagePointId(String ibspSysManagePointId) {
		this.ibspSysManagePointId=ibspSysManagePointId;
	}
	public void setIbspSysManagePointId(Object ibspSysManagePointId) {
		if (ibspSysManagePointId != null) {
			this.ibspSysManagePointId = ibspSysManagePointId.toString();
		}
	}
	public String getIbspSysManagePointId() {
		return this.ibspSysManagePointId ;
	}
