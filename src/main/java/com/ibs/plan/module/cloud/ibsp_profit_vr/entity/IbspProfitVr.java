package com.ibs.plan.module.cloud.ibsp_profit_vr.entity;
...
/**
 * The persistent class for the database table ibsp_profit_vr 
 * IBSP_盘口会员总模拟盈亏 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_profit_vr")
public class IbspProfitVr implements Serializable {
	...
	@Column(name="IBSP_PROFIT_VR_ID_")
	private String ibspProfitVrId;
	public void setIbspProfitVrId(String ibspProfitVrId) {
		this.ibspProfitVrId=ibspProfitVrId;
	}
	public void setIbspProfitVrId(Object ibspProfitVrId) {
		if (ibspProfitVrId != null) {
			this.ibspProfitVrId = ibspProfitVrId.toString();
		}
	}
	public String getIbspProfitVrId() {
		return this.ibspProfitVrId ;
	}
