package com.ibs.plan.module.cloud.ibsp_sys_manage_time.entity;
...
/**
 * The persistent class for the database table ibsp_sys_manage_time 
 * IBSP_用户时长 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_sys_manage_time")
public class IbspSysManageTime implements Serializable {
	...
	@Column(name="IBSP_SYS_MANAGE_TIME_ID_")
	private String ibspSysManageTimeId;
	public void setIbspSysManageTimeId(String ibspSysManageTimeId) {
		this.ibspSysManageTimeId=ibspSysManageTimeId;
	}
	public void setIbspSysManageTimeId(Object ibspSysManageTimeId) {
		if (ibspSysManageTimeId != null) {
			this.ibspSysManageTimeId = ibspSysManageTimeId.toString();
		}
	}
	public String getIbspSysManageTimeId() {
		return this.ibspSysManageTimeId ;
	}
	 ...
	 * 末次报表主键
	 */
	@Column(name="LOG_TIME_ID_")
	private String logTimeId;
	public void setLogTimeId(String logTimeId) {
		this.logTimeId=logTimeId;
	}
	public void setLogTimeId(Object logTimeId) {
		if (logTimeId != null) {
			this.logTimeId = logTimeId.toString();
		}
	}
	public String getLogTimeId() {
