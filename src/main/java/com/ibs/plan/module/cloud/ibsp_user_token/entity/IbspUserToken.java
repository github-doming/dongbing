package com.ibs.plan.module.cloud.ibsp_user_token.entity;
...
/**
 * The persistent class for the database table ibsp_user_token 
 * 投注用户令牌 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_user_token")
public class IbspUserToken implements Serializable {
	...
	@Column(name="IBSP_USER_TOKEN_ID_")
	private String ibspUserTokenId;
	public void setIbspUserTokenId(String ibspUserTokenId) {
		this.ibspUserTokenId=ibspUserTokenId;
	}
	public void setIbspUserTokenId(Object ibspUserTokenId) {
		if (ibspUserTokenId != null) {
			this.ibspUserTokenId = ibspUserTokenId.toString();
		}
	}
	public String getIbspUserTokenId() {
		return this.ibspUserTokenId ;
	}
