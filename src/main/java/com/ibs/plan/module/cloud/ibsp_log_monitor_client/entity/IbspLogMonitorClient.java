package com.ibs.plan.module.cloud.ibsp_log_monitor_client.entity;
...
/**
 * The persistent class for the database table ibsp_log_monitor_client 
 * IBS_客户端详情日志 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_log_monitor_client")
public class IbspLogMonitorClient implements Serializable {
	...
	@Column(name="IBSP_LOG_MONITOR_CLIENT_ID_")
	private String ibspLogMonitorClientId;
	public void setIbspLogMonitorClientId(String ibspLogMonitorClientId) {
		this.ibspLogMonitorClientId=ibspLogMonitorClientId;
	}
	public void setIbspLogMonitorClientId(Object ibspLogMonitorClientId) {
		if (ibspLogMonitorClientId != null) {
			this.ibspLogMonitorClientId = ibspLogMonitorClientId.toString();
		}
	}
	public String getIbspLogMonitorClientId() {
		return this.ibspLogMonitorClientId ;
	}
