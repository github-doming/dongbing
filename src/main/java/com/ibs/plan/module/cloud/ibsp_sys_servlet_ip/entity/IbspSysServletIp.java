package com.ibs.plan.module.cloud.ibsp_sys_servlet_ip.entity;
...
/**
 * The persistent class for the database table ibsp_sys_servlet_ip 
 * IBSP_系统服务IP 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_sys_servlet_ip")
public class IbspSysServletIp implements Serializable {
	...
	@Column(name="IBSP_SYS_SERVLET_IP_ID_")
	private String ibspSysServletIpId;
	public void setIbspSysServletIpId(String ibspSysServletIpId) {
		this.ibspSysServletIpId=ibspSysServletIpId;
	}
	public void setIbspSysServletIpId(Object ibspSysServletIpId) {
		if (ibspSysServletIpId != null) {
			this.ibspSysServletIpId = ibspSysServletIpId.toString();
		}
	}
	public String getIbspSysServletIpId() {
		return this.ibspSysServletIpId ;
	}
