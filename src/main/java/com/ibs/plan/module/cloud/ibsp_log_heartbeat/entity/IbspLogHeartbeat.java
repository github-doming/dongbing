package com.ibs.plan.module.cloud.ibsp_log_heartbeat.entity;
...
/**
 * The persistent class for the database table ibsp_log_heartbeat 
 * IBSP_心跳检测日志 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_log_heartbeat")
public class IbspLogHeartbeat implements Serializable {
	...
	@Column(name="IBSP_LOG_HEARTBEAT_ID_")
	private String ibspLogHeartbeatId;
	public void setIbspLogHeartbeatId(String ibspLogHeartbeatId) {
		this.ibspLogHeartbeatId=ibspLogHeartbeatId;
	}
	public void setIbspLogHeartbeatId(Object ibspLogHeartbeatId) {
		if (ibspLogHeartbeatId != null) {
			this.ibspLogHeartbeatId = ibspLogHeartbeatId.toString();
		}
	}
	public String getIbspLogHeartbeatId() {
		return this.ibspLogHeartbeatId ;
	}
