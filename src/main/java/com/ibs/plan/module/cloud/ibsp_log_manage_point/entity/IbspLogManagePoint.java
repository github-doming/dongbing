package com.ibs.plan.module.cloud.ibsp_log_manage_point.entity;
...
/**
 * The persistent class for the database table ibsp_log_manage_point 
 * IBSP_点数使用情况 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_log_manage_point")
public class IbspLogManagePoint implements Serializable {
	...
	@Column(name="IBSP_LOG_MANAGE_POINT_ID_")
	private String ibspLogManagePointId;
	public void setIbspLogManagePointId(String ibspLogManagePointId) {
		this.ibspLogManagePointId=ibspLogManagePointId;
	}
	public void setIbspLogManagePointId(Object ibspLogManagePointId) {
		if (ibspLogManagePointId != null) {
			this.ibspLogManagePointId = ibspLogManagePointId.toString();
		}
	}
	public String getIbspLogManagePointId() {
		return this.ibspLogManagePointId ;
	}
