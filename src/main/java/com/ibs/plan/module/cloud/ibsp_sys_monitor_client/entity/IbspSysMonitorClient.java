package com.ibs.plan.module.cloud.ibsp_sys_monitor_client.entity;
...
/**
 * The persistent class for the database table ibsp_sys_monitor_client 
 * IBSP_客户端监控信息 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_sys_monitor_client")
public class IbspSysMonitorClient implements Serializable {
	...
	@Column(name="IBSP_SYS_MONITOR_CLIENT_ID_")
	private String ibspSysMonitorClientId;
	public void setIbspSysMonitorClientId(String ibspSysMonitorClientId) {
		this.ibspSysMonitorClientId=ibspSysMonitorClientId;
	}
	public void setIbspSysMonitorClientId(Object ibspSysMonitorClientId) {
		if (ibspSysMonitorClientId != null) {
			this.ibspSysMonitorClientId = ibspSysMonitorClientId.toString();
		}
	}
	public String getIbspSysMonitorClientId() {
		return this.ibspSysMonitorClientId ;
	}
