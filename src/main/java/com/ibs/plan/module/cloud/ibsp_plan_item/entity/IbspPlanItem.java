package com.ibs.plan.module.cloud.ibsp_plan_item.entity;
...
/**
 * The persistent class for the database table ibsp_plan_item
 * IBSP方案详情信息 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsp_plan_item")
public class IbspPlanItem implements Serializable {
	...
	@Column(name="IBSP_PLAN_ITEM_ID_")
	private String ibspPlanItemId;
	public void setIbspPlanItemId(String ibspPlanItemId) {
		this.ibspPlanItemId=ibspPlanItemId;
	}
	public void setIbspPlanItemId(Object ibspPlanItemId) {
		if (ibspPlanItemId != null) {
			this.ibspPlanItemId = ibspPlanItemId.toString();
		}
	}
	public String getIbspPlanItemId() {
		return this.ibspPlanItemId ;
	}
