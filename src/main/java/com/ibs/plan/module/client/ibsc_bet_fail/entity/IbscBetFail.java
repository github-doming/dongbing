package com.ibs.plan.module.client.ibsc_bet_fail.entity;
...
/**
 * The persistent class for the database table ibsc_bet_fail 
 * IBSC客户端_投注失败 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsc_bet_fail")
public class IbscBetFail implements Serializable {
	...
	@Column(name="IBSC_BET_FAIL_ID_")
	private String ibscBetFailId;
	public void setIbscBetFailId(String ibscBetFailId) {
		this.ibscBetFailId=ibscBetFailId;
	}
	public void setIbscBetFailId(Object ibscBetFailId) {
		if (ibscBetFailId != null) {
			this.ibscBetFailId = ibscBetFailId.toString();
		}
	}
	public String getIbscBetFailId() {
		return this.ibscBetFailId ;
	}
