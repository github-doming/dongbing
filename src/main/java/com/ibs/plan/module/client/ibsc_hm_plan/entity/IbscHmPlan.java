package com.ibs.plan.module.client.ibsc_hm_plan.entity;
...
/**
 * The persistent class for the database table ibsc_hm_plan 
 * IBSC客户端_盘口会员与方案 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsc_hm_plan")
public class IbscHmPlan implements Serializable {
	...
	@Column(name="IBSC_HM_PLAN_ID_")
	private String ibscHmPlanId;
	public void setIbscHmPlanId(String ibscHmPlanId) {
		this.ibscHmPlanId=ibscHmPlanId;
	}
	public void setIbscHmPlanId(Object ibscHmPlanId) {
		if (ibscHmPlanId != null) {
			this.ibscHmPlanId = ibscHmPlanId.toString();
		}
	}
	public String getIbscHmPlanId() {
		return this.ibscHmPlanId ;
	}
