package com.ibs.plan.module.client.ibsc_plan_item.entity;
...
/**
 * The persistent class for the database table ibsc_plan_item 
 * IBSC方案详情表 实体类
 * @author Robot
 */
@AnnotationEntity
@AnnotationTable(name = "ibsc_plan_item")
public class IbscPlanItem implements Serializable {
	...
	@Column(name="IBSC_PLAN_ITEM_ID_")
	private String ibscPlanItemId;
	public void setIbscPlanItemId(String ibscPlanItemId) {
		this.ibscPlanItemId=ibscPlanItemId;
	}
	public void setIbscPlanItemId(Object ibscPlanItemId) {
		if (ibscPlanItemId != null) {
			this.ibscPlanItemId = ibscPlanItemId.toString();
		}
	}
	public String getIbscPlanItemId() {
		return this.ibscPlanItemId ;
	}
