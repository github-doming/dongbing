 ...
 * @Version: v1.0
 */
public class BetComJob extends BaseBetJob{
	...
	private void saveBetInfo(Map<String, List<String>> betItemMap, Map<String, Long> fundMap, Map<String, String> hmBetIdMap,
							 String[] items, String hmBetId) {
