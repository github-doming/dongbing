...
<body>
	...
	<form id="id_form_save"
		action="${pageContext.request.contextPath}/all/admin/app/account_user/save/bootstrap2.do"
		method="post">
...
<tr>
 ...
 %>
			...
			<tr>
				...
				<td>${requestScope.account.accountName}</td>
...
<script type="text/javascript">
	...
	function check() {
		...
		//flag = ayCheckColumn("账号名称ACCOUNT_NAME_","id_span$app_account$ACCOUNT_NAME_","id_input$app_account$ACCOUNT_NAME_", "VARCHAR", "yes", "256","0", "0", a, true);
		if (flag) {
		} else {
			return_flag = false;
		}
