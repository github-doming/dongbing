...
<body>
	...
	<form
		action="${pageContext.request.contextPath}/all/admin/app/account_user/list/bootstrap.do"
		...
		<table style="width: 100%; table-layout: fixed" id="id_table"
			...
			<thead>
				<tr>
					...
					<th
						onclick="ayPageOrderEvent('${pageContext.request.contextPath}','APP_ACCOUNT_ID_');"
						title="按[<%=all.app_admin.app.app_account.t.alias.AppAccountTAlias . appAccountId%>]排序"
						style="display: none;cursor: pointer;"><%=all.app_admin.app.app_account.t.alias.AppAccountTAlias.appAccountId%></th>
					<!-- style="display: none; cursor: pointer;" -->
					<th
					...
					<th
						...
						style="display: none; cursor: pointer;"><%=all.app_admin.app.app_account.t.alias.AppAccountTAlias.state%></th>
					<!-- style="display: none; cursor: pointer;" -->
					<th
						...
						style="display: none; cursor: pointer;"><%=all.app_admin.app.app_account.t.alias.AppAccountTAlias.registerType%></th>
...
<script type="text/javascript">
	...
	function delAllRecord(id) {
		var url = "${pageContext.request.contextPath}/all/admin/app/account_user/del_all/bootstrap.do";
	...
	function delRecord(id) {
		if (confirm("确定要删除吗？")) {
			var url = "${pageContext.request.contextPath}/all/admin/app/account_user/del/bootstrap.do?id="
					+ id;
	...
	function updateRecord(id) {
		var url = "${pageContext.request.contextPath}/all/admin/app/account_user/form/update/bootstrap.do?id="
				+ id;
		window.location.href = url;
	}
	/**
	 ...
	 */
	function newRecord() {
		var url = "${pageContext.request.contextPath}/all/admin/app/account_user/form/bootstrap.do";
		window.location.href = url;
	}
</script>