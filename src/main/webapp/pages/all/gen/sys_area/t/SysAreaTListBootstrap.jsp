 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/all/gen/sys_area/t/form/bootstrap.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/all/gen/sys_area/t/form/bootstrap.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/all/gen/sys_area/t/del/bootstrap.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
