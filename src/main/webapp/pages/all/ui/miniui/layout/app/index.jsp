...
<body>
			...
			<div class="mini-splitter" style="width: 100%; height: 100%;"
				...
				<div size="230" maxSize="350" minSize="100"
					...
					<div id="leftTree" class="mini-outlooktree"
						url="${pageContext.request.contextPath}/platform/admin/app/menuListJson.do?pid=${requestScope.menu_id_00010001}"
	...
	<script type="text/javascript">
		...
		function selectMenu(id) {
			var url = "${pageContext.request.contextPath}/platform/admin/app/menuListJson.do";
			url = url + "?pid=" + id;
			tree.load(url);
		}
	</script>
