...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias . sysAccountId%>：</th>
<td>
...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias . sysUserId%>：</th>
<td>
...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias .sysAccountName%>：</th>
<td>
...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias .password%>：</th>
<td>
...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias . desc%>：</th>
<td>
...
<tr>
<th>
<%=all.sys_admin.sys.sys_account.t.alias.SysAccountCxAlias . registerType%>：</th>
<td>
...
class="mini-textbox" style="width: 90%" /></td>
	...
	<script type="text/javascript">
		...
		function save() {
			...
			$.ajax({
				url : "${pageContext.request.contextPath}/all/admin/sys/sys_account/t/save/miniui.do",
				type : "POST",
				data : postData,
