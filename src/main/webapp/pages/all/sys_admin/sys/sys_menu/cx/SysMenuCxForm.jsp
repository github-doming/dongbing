...
<body>
	<form id="id_form_save"
		action="${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/save.do"
		method="post">
...
-->
			...
			<tr style="display: none;">
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.sysMenuId%></td>
			...
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.sysMenuName%></td>
				<td><input id="id_input$sys_menu$NAME_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.sysMenuName%>"
					type="text" name="sys_menu.sysMenuName" value="${requestScope.s.sysMenuName}">
				</td>
				<td><span id="id_span$sys_menu$NAME_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.path%></td>
				<td><input size=100  id="id_input$sys_menu$PATH_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . path%>"
					type="text" name="sys_menu.path" value="${requestScope.s.path}">
				</td>
				<td><span id="id_span$sys_menu$PATH_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.treeCode%></td>
				<td><input id="id_input$sys_menu$TREE_CODE_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . treeCode%>"
					type="text" name="sys_menu.treeCode"
					value="${requestScope.s.treeCode}"></td>
				<td><span id="id_span$sys_menu$TREE_CODE_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.url%></td>
				<td><input size=100 id="id_input$sys_menu$URL_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . url%>"
					type="text" name="sys_menu.url" value="${requestScope.s.url}">
				</td>
				<td><span id="id_span$sys_menu$URL_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.parent%></td>
				<td><input id="id_input$sys_menu$PARENT_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . parent%>"
					type="text" name="sys_menu.parent" value="${requestScope.s.parent}">
				</td>
				<td><span id="id_span$sys_menu$PARENT_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.picOpen%></td>
				<td><input id="id_input$sys_menu$PIC_OPEN_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . picOpen%>"
					type="text" name="sys_menu.picOpen"
					value="${requestScope.s.picOpen}"></td>
				<td><span id="id_span$sys_menu$PIC_OPEN_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.picClose%></td>
				<td><input id="id_input$sys_menu$PIC_CLOSE_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . picClose%>"
					type="text" name="sys_menu.picClose"
					value="${requestScope.s.picClose}"></td>
				<td><span id="id_span$sys_menu$PIC_CLOSE_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.pic%></td>
				<td><input id="id_input$sys_menu$PIC_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . pic%>"
					type="text" name="sys_menu.pic" value="${requestScope.s.pic}">
				</td>
				<td><span id="id_span$sys_menu$PIC_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.sn%></td>
				<td><input id="id_input$sys_menu$SN_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . sn%>"
					type="text" name="sys_menu.sn" value="${requestScope.s.sn}">
				</td>
				<td><span id="id_span$sys_menu$SN_"></span></td>
			</tr>
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.permissionGrade%></td>
				<td><input id="id_input$sys_menu$PERMISSION_GRADE_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . permissionGrade%>"
			...
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.permissionCode%></td>
				<td><input id="id_input$sys_menu$PERMISSION_CODE_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . permissionCode%>"
			...
			<tr>
				<td align="right"><%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias.state%></td>
				<td><input id="id_input$sys_menu$STATE_"
					placeholder="请输入<%=all.sys_admin.sys.sys_menu.cx.alias.SysMenuCxAlias . state%>"
...
<script type="text/javascript">
	...
	function parent(path) {
		...
		//alert('path='+path);
		var url = "${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/parent.do";
		url = url + "?path=" + path;
		var name = 'newwindow';
	 ...
	 */
	function back() {
		var url = "${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/list.do";
	...
	function check() {
		...
		flag = ayCheckColumn("PIC_OPEN_", "id_span$sys_menu$PIC_OPEN_",
				"id_input$sys_menu$PIC_OPEN_", "VARCHAR", "yes", "256", "0",
				"0", a, true);
		if (flag) {
		} else {
			return_flag = false;
		}
		flag = ayCheckColumn("PIC_CLOSE_", "id_span$sys_menu$PIC_CLOSE_",
				"id_input$sys_menu$PIC_CLOSE_", "VARCHAR", "yes", "256", "0",
				"0", a, true);
		if (flag) {
		} else {
			return_flag = false;
		}
		flag = ayCheckColumn("PIC_", "id_span$sys_menu$PIC_",
				"id_input$sys_menu$PIC_", "VARCHAR", "yes", "256", "0", "0", a,
				true);
		if (flag) {
		} else {
			return_flag = false;
