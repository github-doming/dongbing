 ...
 */
 function editRecord(id){
	//alert('id='+id);
	 	var url= "${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/form.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/form.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/all/admin/sys/sys_menu/cx/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
