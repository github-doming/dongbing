...
<frameset cols="30%,*">
	...
	<frame scrolling=yes frameborder=1 id="id_frame_first"
		...
		src="${pageContext.request.contextPath}/all/sys_admin/sys/dict/sys_dict_tree/list/bootstrap.do">
	<frame scrolling=yes frameborder=1 id="id_frame_second"
		name="name_frame_second"
		src="${pageContext.request.contextPath}/all/sys_admin/sys/dict/sys_dict/list/bootstrap.do">
