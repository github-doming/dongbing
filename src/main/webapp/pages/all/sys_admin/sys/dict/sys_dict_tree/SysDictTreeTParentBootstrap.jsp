...
<body>
<form id="id_form_tree" method="post">选择上一级数据字典 <input
...
var url= "${pageContext.request.contextPath}/all/sys_admin/sys/dict/sys_dict_tree/select.do?parent_id="+parent_id;
