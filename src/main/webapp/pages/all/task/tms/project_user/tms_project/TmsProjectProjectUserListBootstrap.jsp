...
ayTreeTable_file_click_my= function(db_id,id_tr,id_name,url) {
	...
	var action="${pageContext.request.contextPath}/all/task/tms/project_user/app_user/list/bootstrap.do";
 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/all/task/tms/project_user/tms_project/form/bootstrap.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/all/task/tms/project_user/tms_project/form/bootstrap.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/all/task/tms/project_user/tms_project/del/bootstrap.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
...
<script type="text/javascript">
	 ...
	 */
	function tree(state) {
		var url = "${pageContext.request.contextPath}/all/task/tms/project_user/tms_project/list/bootstrap.do";
