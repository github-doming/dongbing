 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/all/task/tms/tms_task/t/form/bootstrap.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/all/task/tms/tms_task/t/form/bootstrap.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/all/task/tms/tms_task/t/del/bootstrap.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
