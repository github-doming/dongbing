  ...
  <body class="signinBg">
      ...
      <div class="rightForm">
	    <form   id="signinForm"  method="POST">
	      <div style="height: 500px;" class="signinForm">
	        <p>欢迎登录</p>
	        
	     
	       <div class="userName">
	          <span class="signinFormicon"><i class="fa fa-user"></i></span>
	          <input value="sys" type="text" class="user" name="j_project" placeholder="项目名" id="j_project"/>
	        </div>
	        ...
	        <div class="userName">
	          <span class="signinFormicon"><i class="fa fa-user"></i></span>
	          <input value="ibm" type="text" class="user" name="j_org" placeholder="机构名" id="j_org"/>
	        </div>
	        ...
	        <div class="userName">
	          <span class="signinFormicon"><i class="fa fa-user"></i></span>
	          <input value="admin" type="text" class="user" name="j_username" placeholder="用户名" id="j_username"/>
	        </div>
