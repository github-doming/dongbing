...
<tr>
		...
		<td><input id="idInput_ActwfFormDefT_name" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . name%>"  type="text" name="actwf_form_def.name"
...
<tr>
		...
		<td><input id="idInput_ActwfFormDefT_title" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . title%>"  type="text" name="actwf_form_def.title"
...
<tr style="display: none;">
		...
		<td><input id="idInput_ActwfFormDefT_content" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . content%>"  type="text" name="actwf_form_def.content"
...
<tr>
		...
		<td><input size=100 id="idInput_ActwfFormDefT_urlView" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . urlView%>"  type="text" name="actwf_form_def.urlView"
...
<tr>
		...
		<td><input size=100 id="idInput_ActwfFormDefT_urlUpload" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . urlUpload%>"  type="text" name="actwf_form_def.urlUpload"
...
<tr>
		...
		<td><input size=100 id="idInput_ActwfFormDefT_urlDownload" placeholder="请输入<%=all.workflow.actwf.actwf_form_def.t.alias.ActwfFormDefTAlias . urlDownload%>"  type="text" name="actwf_form_def.urlDownload"
...
<tr>
				...
				<td><span defValue="${requestScope.s.state}" id="idDiv_a" name="actwf_form_def.state"
				...
				<td><span id="idSpan_ActwfFormDefT_state"></span></td>
			</tr>
<tr>
