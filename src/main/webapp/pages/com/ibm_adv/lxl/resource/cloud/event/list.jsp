            ...
            <c:forEach items="${list}" var="item" varStatus="loop">
                <tr >
                    ...
                    <td style="width: 150px;">
                        ...
                        <button style="border: 5px #FFFFFF solid; border-radius: 5px; background-color: #FFE4C4; color: #2d2d2d;" class="btn btn-primary" data-toggle="modal" data-target="#myModal${loop.count-1}">
                                点击查看
                        </button>
                        <!-- 模态框 -->
...
<%--<button type="button" onclick="getdate()">1111111111</button>--%>

<%--<script type="text/javascript">--%>
<%--    function getdate(){--%>
<%--        $.ajax({--%>
<%--            url : '/a/ibm/admin/hadicap/list',--%>
<%--            type : 'post',--%>
<%--            dataType : 'json',--%>
