...
<form id="id_form_save"
	action="${pageContext.request.contextPath}/com/ibm/admin/webservletcontent/edit.do"
	method="post">
...
<tr>
		...
		<td align="left" ><input id="id_input$ibm_input$corePoolSize" placeholder="请输入线程池核心大小"  type="text" name="corePoolSize"
...
<tr>
		...
		<td align="left" ><input id="id_input$ibm_input$maximumPoolSize" placeholder="请输入线程池最大容量"  type="text" name="maximumPoolSize"
...
<tr>
		...
		<td align="left" ><input id="id_input$ibm_input$keepAliveTimeSeconds" placeholder="请输入线程池空闲时间"  type="text" name="keepAliveTimeSeconds"
