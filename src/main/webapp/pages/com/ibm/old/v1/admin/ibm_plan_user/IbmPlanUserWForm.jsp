...
<center>
	<div style="color:white;width:100%;height:100px;background-color:rgb(29,41,57);padding-top:20px">
		<span style="font-size:30px;">用户方案管理
			<c:choose>
...
<form id="id_form_save"
	action="${pageContext.request.contextPath}/ibm/admin/ibm_plan_user/t/save.do"
	method="post">
...
<tr>
		<td align="right" width="45%">用户方案名称</td>
		<td align="left" ><input id="topicId_input"  type="hidden" name="IBM_PLAN_USER_ID_"
			value="${requestScope.s.ibmPlanUserId}">
			<select id="id_select_PLAN_NAME_" name="IBM_PLAN_ID_"></select>
		</td>
</tr>	
<tr>
				 ...
				 success:function(data){
					var option;
				 	$(data.data).each(function(i,v){
				 		if('${requestScope.s.planId}'==v.IBM_PLAN_ID_){
				 			option = "<option value='"+v.IBM_PLAN_ID_+"' selected='selected' >"+v.PLAN_NAME_+":"+v.GAME_NAME_+"</option>";
				 		}else{
				 			option = "<option value='"+v.IBM_PLAN_ID_+"' >"+v.PLAN_NAME_+":"+v.GAME_NAME_+"</option>";
				 		}
				 		var plan_selects = $("#id_select_PLAN_NAME_");
...
flag=ayCheckColumn("会员最大在线数量","id_span$ibm_plan$ONLINE_NUMBER_MAX_","id_input$ibm_input$ONLINE_NUMBER_MAX_","INT","no","4","0","0",a,true);
