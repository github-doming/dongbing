...
<body>
<form id="id_form_save" action="${pageContext.request.contextPath}/ibm/admin/manage/client/clientCapacitySet1" method="post">
    <table class="table  table-bordered table-hover" border="1">
        ...
        <tr>
            <td align="right">客户端最大容量:
            </td>
            <td><input id="id_input$clientCapacityMax" placeholder="请输入容量" type="text"
                       name="clientCapacityMax" value="${requestScope.CLIENT_CAPACITY_MAX_ }">
            </td>
            <td><span id="id_span$clientCapacityMax"></span>
            </td>
        </tr>
    </table>
</form>
