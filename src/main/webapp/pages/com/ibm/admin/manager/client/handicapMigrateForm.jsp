...
<form id="id_form_save"
      action="${pageContext.request.contextPath}/ibm/admin/manage/client/handicapMigrate1"
      method="post">
    <table class="table  table-bordered table-hover" border="1">
        ...
        <tr>
            ...
            <td><input id="id_input$customerType" type="text" name="customerType" ></td>
            <td><span id="id_span$customerType"></span></td>
        </tr>
        <tr>
            <td align="right">盘口编码:</td>
            <td><input id="id_input$handicapCode" type="text" name="handicapCode"></td>
            <td><span id="id_span$handicapCode"></span></td>
        </tr>
        <tr>
