...
<div class="head">
    <div class="col-xs-10 col-xs-offset-1">
        <form class="form-inline head-form"
              action="${pageContext.request.contextPath}/ibm/admin/manage/log/heartbeat" style="padding:  15px 0 15px 0">
            <div style="float: right">
                <div class="form-group" style="padding:0 15px 0 15px">
                    <select name="heartbeatResult" id="heartbeatResult" onchange="submitFrom()" style="height: 26px">
    ...
    <div class="col-xs-10 col-xs-offset-1">
        <table class="table  table-bordered table-hover">
            ...
            <tr>
                ...
                <th style="width: 200px;text-align: center;">心跳时间</th>
                <th class='text-center'>心跳结果</th>
            </tr>
            </thead>
            ...
            <c:forEach items="${list}" var="list" varStatus="loop">
                <tr>
                    ...
                    <td class="text-center">
                        <c:if test="${list.HEARTBEAT_RESULT_=='SUCCESS'}">成功</c:if>
                        <c:if test="${list.HEARTBEAT_RESULT_=='FAIL'}">失败</c:if>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
