...
<div class="head">
    <div class="col-xs-10 col-xs-offset-1">
        <form class="form-inline head-form" id="query"
...
<script type="text/javascript">
    ...
    function initTable() {
        $.ajax({
            ...
            dataType : "json",
            async:false,
            url: "${pageContext.request.contextPath}/ibm/admin/manage/feedback/queryAllBugfeedback",//请求的action路径页面
            data: {"flag":true},
            ...
            success:function(data){ //请求成功后处理函数。
                ...
                var options = {
                    ...
                    onPageClicked: function (event, originalEvent, type, page) {
                        $.ajax({
                            url: "${pageContext.request.contextPath}/ibm/admin/manage/feedback/queryAllBugfeedback",
                            type: "GET",
                            dataType : "json",
                            data: "page=" + page,
