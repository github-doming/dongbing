...
// 图片
var ayTreeLoad_img_file_b = '/pages/c/x/imports/compo/tree_table/images3/v1/file.png';
var ayTreeLoad_img_folder_close_b = '/pages/c/x/imports/compo/tree_table/images3/v1/folder-closed.png';
var ayTreeLoad_img_folder_open_b = '/pages/c/x/imports/compo/tree_table/images3/v1/folder.png';
...
//				+ "'></input>";
		//var key2 = "id_tr_" + id + "_" + ayTreeLoad_key;
		var c="&nbsp;&nbsp;&nbsp;<input alt="+path+" onclick=ayTreeLoad_checkbox_all(this,'"+ ayTreeLoad_key+"'); name='name_checkbox_my' value='87' type='checkbox'>";
		html$name =c+ "&nbsp;&nbsp;&nbsp;<input  class='btn btn-link' type='button' value='" + name
		+ "'></input>";
	}
	// 7拼装
