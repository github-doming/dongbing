...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/imports/feng/js/ay_div.js?version=">
        </script>
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/imports/feng/calendar/calendar.js?version=3">
        </script>
<style type="text/css">
/*
整个日期div样式
...
<table border=0>
	...
	<tr>
		<td align="left"><span>时间</span> <select style="width: 58px;"
