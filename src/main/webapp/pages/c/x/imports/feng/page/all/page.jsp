...
<table>
	...
	<tr>
		<td align="center">每页 <select   style="width:60px;" name="pageIndexName_size"
		...
		当前第<input    style="width:60px;" id="id_gopage" name="name_gopage" type="text" value="${cPage.pageIndex}"
			...
			href="#">跳转</a><B> &nbsp;&nbsp;共 ${cPage.totalPages}页</B> <a
			onclick="${requestScope.value_js_cmd_show_all}(this,'${pageContext.request.contextPath}');"
			href="#"><span id="id_span_show_all">${requestScope.value_text_span_show_all}</span></a>
		</td>
	</tr>
	<!-- 分页 -->
</table>
