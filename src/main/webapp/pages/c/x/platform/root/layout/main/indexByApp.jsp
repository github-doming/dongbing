 ...
 --> <%
 	java.util.ArrayList<java.util.HashMap<String, Object>> listMap=(java.util.ArrayList<java.util.HashMap<String, Object>>)	request.getAttribute("menuFirstMapList");
   			if(listMap!=null){
   				...
   				String id=(String)map.get("APP_MENU_ID_");
   				String liId="liId_"+id;
   				String name=(String)map.get("APP_MENU_NAME_");
 %> <input id='<%=liId%>'
...
<script type="text/javascript">
	...
	function funMenuFirstMapList(id, liId) {
		...
		var url = '${pageContext.request.contextPath}/platform/admin/app/tree_table.do?parent_id=' + id;
	...
	//加载第二级菜单
	var treeIframeObj = top.document.getElementById("treeIframeId");
	var url = '${pageContext.request.contextPath}/platform/admin/app/tree_table.do?parent_id=${requestScope.menu_id_00010001}';
	treeIframeObj.src = url;
</script>
<script type="text/javascript">
