...
<script
	src="${pageContext.request.contextPath}/pages/c/x/includes/simple/jquery_validate/1.19.0/jquery.validate.js"></script>
<script
	src="${pageContext.request.contextPath}/pages/c/x/includes/simple/jquery_validate/messages_zh.js"></script>
	
	        <%--
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/cosmos/lib/all/complex/editor/ckeditor/4.11.2/ckeditor.js?version=<%=version %>">
        </script>--%>
...
<%
	...
	// WebRoot URL 路径
	String c_contextPath_all = request.getScheme() + "://" + request.getServerName() + ":"
