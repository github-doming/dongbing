...
<%@ include file="/pages/c/x/a/admin/feng/compo/tree_table/includes/common/version.jsp"%>
...
<!-- Bootstrap -->
<link
	href="${pageContext.request.contextPath}/pages/c/x/includes/simple/bootstrap/css/bootstrap.min.css_v1"
	rel="stylesheet" media="screen">
	
	<link
	href="${pageContext.request.contextPath}/pages/c/x/includes/simple/css/ay/list/css_green.css"
	rel="stylesheet" media="screen">
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/imports/compo/tree_table/js/ay_tree_table.js?version=<%=version %>">
        ...
        <script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/a/admin/feng/compo/tree_table/includes/tree_load/js/ay_tree_load.js?version=<%=version %>">
        </script>
