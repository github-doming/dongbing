...
<!-- 加载bootstrap的js -->
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/includes/simple/bootstrap3/js/bootstrap.js">
        </script>
<!-- 加载自定义的js -->
<script type="text/javascript"
...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/imports/compo/tree_table/js/ay_tree_table.js?version=<%=version %>">
        ...
        <script type="text/javascript"
	src="${pageContext.request.contextPath}/pages/c/x/imports/compo/tree_load/js3/ay_tree_load.js?version=<%=version %>">
        </script>
