...
<form action="${pageContext.request.contextPath}/cxy/simple/cxy_simple_upload/admin/upload/sys_lob_info/list_object/bootstrap.do"  id="id_form_list" method="post">
