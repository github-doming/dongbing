 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/c/x/platform/admin/gen/fun_single_simple/gen_tree_simple/form.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/c/x/platform/admin/gen/fun_single_simple/gen_tree_simple/form.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/c/x/platform/admin/gen/fun_single_simple/gen_tree_simple/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
