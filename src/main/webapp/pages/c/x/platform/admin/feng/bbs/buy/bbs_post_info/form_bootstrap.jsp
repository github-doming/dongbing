...
<table class="table  table-bordered table-hover" border="1">
	...
	<tr>
		...
		<td><input id="id_input_parent_menu_id" type="text"
			name="bbs_forum_info.parent" value="${requestScope.p.id}"></td>
		<td></td>
	</tr>
	<tr>
		<td>
...
<tr>
		...
		<td><input id="id_input$bbs_post_info$id" placeholder="请输入<%=c.x.platform.feng.feng.bbs.buy.bbs_post_info.alias.BbsPostInfoAlias . id%>"  type="text" name="bbs_post_info.id"
...
<tr>
	...
	<textarea  id="id_input$bbs_post_info$content" class="ckeditor"  name="bbs_post_info.content">
...
<tr>
		...
		<td><input id="id_input$bbs_post_info$title" placeholder="请输入<%=c.x.platform.feng.feng.bbs.buy.bbs_post_info.alias.BbsPostInfoAlias . title%>"  type="text" name="bbs_post_info.title"
