...
<script type="text/javascript">
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/pages/c/x/d/admin/feng/bs/sys/fav/sys_org_info/form.do?action=edit&&id="+id;

	 	window.location.href=url;
}
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/pages/c/x/d/admin/feng/bs/sys/fav/sys_org_info/form.do?action=new&&parent_id="+parent_id;
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/pages/c/x/d/admin/feng/bs/sys/fav/sys_org_info/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
