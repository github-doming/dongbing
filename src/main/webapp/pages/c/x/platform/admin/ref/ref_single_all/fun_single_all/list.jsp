...
<table id="id_table" class="table  table-bordered table-hover">
 ...
 <tr>
  ...
  <tbody>
	...
	<%
		java.util.ArrayList<c.x.platform.admin.ref.gen.single_simple.entity.GenSingleSimple> listMap = (java.util.ArrayList<c.x.platform.admin.ref.gen.single_simple.entity.GenSingleSimple>) request
				.getAttribute("list");

		for (c.x.platform.admin.ref.gen.single_simple.entity.GenSingleSimple info : listMap) {
	%>
	...
	<tr>
		...
		<td>
				 ...
				 <a 
		onclick="delRecord('<%=info.getSysId()%>')" href="#"> 删除 </a>
			
			
			
			 <a 
			onclick="updateRecord('<%=info.getSysId()%>')" href="#"> 编辑 </a></td>
