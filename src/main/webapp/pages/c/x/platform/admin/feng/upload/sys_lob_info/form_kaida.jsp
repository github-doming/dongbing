...
<tr bgcolor="#FFFFFF">
		...
		<td style="width:25%;"><span id="id_span$sys_lob_info$file_name"></span>
		</td>
</tr>	
<tr bgcolor="#FFFFFF">
...
onclick=ayCalendarShow('id_input$sys_lob_info$create_time',event,'DATETIME'); src="${pageContext.request.contextPath}/pages/c/x/imports/feng/calendar/images/calendar.gif"></img>
		...
		<td style="width:25%;"><span id="id_span$sys_lob_info$create_time"></span>
		</td>
</tr>	
	<tr bgcolor="#FFFFFF">
 ...
 */
function back(){
var url = "${pageContext.request.contextPath}/cxy/simple/cxy_simple_upload/admin/upload/sys_lob_info/list/kaida.do";
