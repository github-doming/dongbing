...
ayTreeTable_file_click_my= function(db_id,id_tr,id_name,url) {
	...
	var action="${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/bbs/cx/bbs_note_info/list/bootstrap.do";
 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/bbs/cx/bbs_notegroup_info/form/bootstrap.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/bbs/cx/bbs_notegroup_info/form/bootstrap.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/bbs/cx/bbs_notegroup_info/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
