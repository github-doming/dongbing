...
<form action="${pageContext.request.contextPath}/cxy/simple/cxy_simple_upload/admin/upload/sys_lob_info/list/bootstrap.do"  id="id_form_list" method="post">
...
<th
	...
	<!--  style="display: none;word-wrap : break-word;" -->
	<td style="word-wrap : break-word;  " id="hit.file_name">&nbsp;<%=info.get("file_name")%></td>
	<!--  style="display: none;word-wrap : break-word;" -->
	<td style="word-wrap : break-word;  " id="hit.file">&nbsp;<%=info.get("file")%></td>
	<!--  style="display: none;word-wrap : break-word;" -->
	<td style="word-wrap : break-word;  " id="hit.user_id">&nbsp;<%=info.get("user_id")%></td>
	<!--  style="display: none;word-wrap : break-word;" -->
	<td style="word-wrap : break-word;  " id="hit.create_time">&nbsp;<%=info.get("create_time")%></td>
...
function updateRecord(id){
	var url= "${pageContext.request.contextPath}/cxy/simple/cxy_simple_upload/admin/upload/sys_lob_info/form/bootstrap.do?id="+id;
 	window.location.href=url;
}
/**
 * 
 ...
 */
function newRecord(){
 	var url= "${pageContext.request.contextPath}/cxy/simple/cxy_simple_upload/admin/upload/sys_lob_info/form/bootstrap.do";
 	window.location.href=url;
}
	</script>