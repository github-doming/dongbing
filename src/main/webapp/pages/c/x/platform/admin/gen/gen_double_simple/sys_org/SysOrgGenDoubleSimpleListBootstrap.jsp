...
ayTreeTable_file_click_my= function(db_id,id_tr,id_name,url) {
	...
	var action="${pageContext.request.contextPath}/c/x/platform/admin/gen/gen_double_simple/sys_user/list.do";
 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/c/x/platform/admin/gen/gen_double_simple/sys_org/form.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/c/x/platform/admin/gen/gen_double_simple/sys_org/form.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/c/x/platform/admin/gen/gen_double_simple/sys_org/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
