...
ayTreeTable_file_click_my= function(db_id,id_tr,id_name,url) {
	...
	var action="${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/pss/gen3/pss_product_info/list.do";
 ...
 */
 function editRecord(id){
	 	var url= "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/pss/gen3/pss_productgroup_info/form.do?action=edit&&id="+id;
 ...
 function newRecord(parent_id){
 	var url= "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/pss/gen3/pss_productgroup_info/form.do?action=new&&parent_id="+parent_id;
 	window.location.href=url;
 }
 /**
  * 删除
 ...
 function delRecord(id){
		...
		{
			var url = "${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/pss/gen3/pss_productgroup_info/del.do?id="+id;
		 	window.location.href= url;
		}
		else
		{
