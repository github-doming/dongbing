...
<form action="${pageContext.request.contextPath}/pages/c/x/platform/admin/feng/upload/admin/upload/sys_lob_info/list.do"  id="id_form_list" method="post">
...
function delAllRecord(id){
	var url = "${pageContext.request.contextPath}/admin/upload/sys_lob_info/del_all.do";
...
function delRecord(id){
	if(confirm("确定要删除吗？"))
	{
		var url = "${pageContext.request.contextPath}/admin/upload/sys_lob_info/del.do?id="+id;
...
function updateRecord(id){
	var url= "${pageContext.request.contextPath}/admin/upload/sys_lob_info/form.do?id="+id;
 	window.location.href=url;
}
/**
 * 
 ...
 */
function newRecord(){
 	var url= "${pageContext.request.contextPath}/admin/upload/sys_lob_info/form.do";
 	window.location.href=url;
}
	</script>