...
<form id="id_form_save"
	action="${pageContext.request.contextPath}/c/x/platform/sys/sys_account/cx/save.do"
	method="post">
<table class="table  table-bordered table-hover" border="1">
<tr style="display: none;">
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . sysAccountId%></td>
...
<tr style="display: none;">
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . sysUserId%></td>
		<td><input readonly="readonly" id="idInput_sysAccount_sysUserId" placeholder="请输入<%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . sysUserId%>"  type="text" name="sys_account.sysUserId"
...
<tr>
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias .sysAccountName%></td>
		<td><input id="id_input$sys_account$SYS_ACCOUNT_NAME_" placeholder="请输入<%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias .sysAccountName%>"  type="text" name="sys_account.sysAccountName"
...
<tr>
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias .password%></td>
		<td><input id="id_input$sys_account$PASSWORD_" placeholder="请输入<%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias .password%>"  type="text" name="sys_account.password"
...
<tr>
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . desc%></td>
		<td><input id="id_input$sys_account$DESC_" placeholder="请输入<%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . desc%>"  type="text" name="sys_account.desc"
...
<tr>
		<td align="right"><%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . registerType%></td>
		<td><input id="id_input$sys_account$REGISTER_TYPE_" placeholder="请输入<%=c.x.platform.sys.sys_account.cx.alias.SysAccountCxAlias . registerType%>"  type="text" name="sys_account.registerType"
...
<div class="modal fade" id="idBootstrapModal" tabindex="-1" role="dialog" 
   ...
   <div class="modal-dialog modal-lg">
    ...
    $(document).ready(function() {
        $("#IdJqGrid").jqGrid({
            url: '${pageContext.request.contextPath}/example/c/x/all/complex/table/jq_grid/sys_user/list/json.do',
            mtype: "GET",
            //styleUI : 'Bootstrap',
            height: 300,
            rowNum: 10,
 ...
 */
function back(){
var url = "${pageContext.request.contextPath}/c/x/platform/sys/sys_account/cx/list.do";
...
if(flag){}else{return_flag=false;}
flag=ayCheckColumn("注册类型1管理员2公司员工3手机5邮箱6qq7微信8支付宝9百度10新浪","id_span$sys_account$REGISTER_TYPE_","id_input$sys_account$REGISTER_TYPE_","INT UNSIGNED","yes","10","0","0",a,true);
if(flag){}else{return_flag=false;}
	return return_flag;
}
/**
